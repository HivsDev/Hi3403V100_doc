...
-   **[概念](#ZH-CN_TOPIC_0000002457880877)**  

-   **[DIS基本原理](#ZH-CN_TOPIC_0000002424361962)**  

-   **[DIS的实现](#ZH-CN_TOPIC_0000002457880761)**  
...
-   **[DIS使用](#ZH-CN_TOPIC_0000002457840773)**  

-   **[参数设置](#ZH-CN_TOPIC_0000002457840657)**  

-   **[陀螺仪使用](#ZH-CN_TOPIC_0000002424202142)**  

-   **[镜头标定](#ZH-CN_TOPIC_0000002424202106)**  
...
![](figures/zh-cn_formulaimage_0000002506179990.png)

旋转矩阵matrix\[OT\_MFUSION\_MATRIX\_NUM\]的9个参数分别对应\[a,b,c,d,e,f,g,h,i\]。计算9个参数的具体方法请参见“[适配陀螺仪和图像坐标系方向](#ZH-CN_TOPIC_0000002424361994)”。
...
**fpd\_adaptive\_en<a name="section1212444715717"></a>**
...
-   **[陀螺仪算法的流程](#ZH-CN_TOPIC_0000002457880829)**  

-   **[陀螺仪驱动参考代码](#ZH-CN_TOPIC_0000002424202018)**  

-   **[适配陀螺仪和图像坐标系方向](#ZH-CN_TOPIC_0000002424361994)**  

-   **[镜头标定参数和timelag](#ZH-CN_TOPIC_0000002424361898)**  

-   **[hmax\_times、vmax和曝光时间](#ZH-CN_TOPIC_0000002424361846)**  

-   **[初始化和启动陀螺仪](#ZH-CN_TOPIC_0000002424361878)**  

-   **[陀螺仪和加速度计的配置](#ZH-CN_TOPIC_0000002457840697)**  

-   **[陀螺仪防抖强度的应用方案](#ZH-CN_TOPIC_0000002424202150)**  

-   **[IMU传感器参数影响和选型要求](#ZH-CN_TOPIC_0000002457840709)**  

-   **[陀螺仪驱动对接流程](#ZH-CN_TOPIC_0000002424202042)**  
...
-   **[棋盘格标定](#ZH-CN_TOPIC_0000002424202062)**  

-   **[视场角标定](#ZH-CN_TOPIC_0000002457840677)**  

### 棋盘格标定<a name="ZH-CN_TOPIC_0000002424202062"></a>

-   **[标定工具](#ZH-CN_TOPIC_0000002457880781)**  

-   **[下板端](#ZH-CN_TOPIC_0000002424361926)**  
...
-   **[应用背景](#ZH-CN_TOPIC_0000002457880817)**  

-   **[FOV转换ldc\_v2](#ZH-CN_TOPIC_0000002424361942)**  

-   **[FOV转换注意事项](#ZH-CN_TOPIC_0000002424361914)**  

-   **[FOV转换sample](#ZH-CN_TOPIC_0000002424361982)**  

#### 应用背景<a name="ZH-CN_TOPIC_0000002457880817"></a>

在室外变焦应用中，由于视场角和焦段在逐步的变化，使用镜头标定获得ldc\_v2的方法对逐个焦段进行标定比较复杂。为了寻求更简单有效的方法，通过给定镜头的视场角来转换成ldc\_v2参数以替代镜头棋盘格标定。
...
-   **[测试陀螺仪数值是否合理](#ZH-CN_TOPIC_0000002457840721)**  

-   **[陀螺仪时间戳是否平滑](#ZH-CN_TOPIC_0000002457880889)**  

-   **[正确配置和使能零偏修正功能](#ZH-CN_TOPIC_0000002457880865)**  

-   **[陀螺仪防抖没有效果](#ZH-CN_TOPIC_0000002457840745)**  

-   **[读取IMU数据的两种方式](#ZH-CN_TOPIC_0000002457880849)**  

-   **[WDR模式的陀螺仪防抖效果](#ZH-CN_TOPIC_0000002457840785)**  

-   **[陀螺仪防抖开关切换中画面有残影](#ZH-CN_TOPIC_0000002469587265)**  
...
2.  计算静止状态下角速度/加速度的各方向的均方根值，并根据sensor的配置与手册资料适配计算得到标准差，如果标准差在手册标称噪声0.5\~2倍以内，可以认为sensor适配正确，如果在手册标称噪声2倍\~5倍之间，则可能sensor的工作环境有改善空间\(热、应力分布、远离电磁干扰源、机械振动干扰源等\)，如果超过5倍或远小于手册标称噪声\(如小于1/3\)则认为适配sensor错误，需要检查相关配置。
