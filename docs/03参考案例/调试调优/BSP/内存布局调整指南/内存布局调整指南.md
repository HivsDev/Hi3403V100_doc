...
|**文档版本**|**发布日期**|**修改说明**|
|--|--|--|
|00B02|2026-03-05|第2次临时版本发布。“2.1 U-Boot”小节涉及修改|
...
-   **[U-Boot](#ZH-CN_TOPIC_0000002424361986)**  

-   **[Linux内核](#ZH-CN_TOPIC_0000002424361998)**  

-   **[ATF](#ZH-CN_TOPIC_0000002457840765)**  

-   **[GSL](#ZH-CN_TOPIC_0000002457880857)**  

-   **[MPP](#ZH-CN_TOPIC_0000002457880837)**  

## U-Boot<a name="ZH-CN_TOPIC_0000002424361986"></a>

open\_source/u-boot-yyyy/configs/xxxx\_defconfig

CONFIG\_KERNEL\_LOAD\_ADDR，规定了内核启动的地址；U-Boot 根据此地址的偏移来加载各模块数据。

## Linux内核<a name="ZH-CN_TOPIC_0000002424361998"></a>

open\_source/linux-yyyy/arch/arm64/boot/dts/vendor/xxxx-demb.dts
...
open\_source/arm-trusted-firmware-yyyy/plat/vendor/xxxx/include/platform\_def.h
...
BL31\_BASE = CONFIG\_KERNEL\_LOAD\_ADDR + 0x2F80000 （[CONFIG\_KERNEL\_LOAD\_ADDR](#CONFIG_KERNEL_LOAD_ADDR)  是 U-Boot 中定义的内核启动地址。）

## GSL<a name="ZH-CN_TOPIC_0000002457880857"></a>

osdrv/components/boot/gsl/include/xxxx/platform.h

KERNEL\_LOAD\_ADDR，内核启动地址。

地址关系：

KERNEL\_LOAD\_ADDR = CONFIG\_KERNEL\_LOAD\_ADDR （[CONFIG\_KERNEL\_LOAD\_ADDR](#CONFIG_KERNEL_LOAD_ADDR)  是 U-Boot 中定义的内核启动地址。）
...
-   **[Linux 内核往前移动0x10000000](#ZH-CN_TOPIC_0000002457840777)**  

-   **[扩大Linux空间大小](#ZH-CN_TOPIC_0000002424361970)**  

## Linux 内核往前移动0x10000000<a name="ZH-CN_TOPIC_0000002457840777"></a>

-   **[修改方案](#ZH-CN_TOPIC_0000002424202158)**  

-   **[修改点](#ZH-CN_TOPIC_0000002457840789)**  
...
-   **[修改方案](#ZH-CN_TOPIC_0000002457880893)**  

-   **[修改点](#ZH-CN_TOPIC_0000002424202098)**  
