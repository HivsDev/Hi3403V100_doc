...
-   **[工具概述](#ZH-CN_TOPIC_0000002530061733)**  

-   **[环境准备说明](#ZH-CN_TOPIC_0000002530221735)**  

-   **[PC端软件的安装](#ZH-CN_TOPIC_0000002498301772)**  

-   **[快速入门](#ZH-CN_TOPIC_0000002498301786)**  

## 工具概述<a name="ZH-CN_TOPIC_0000002530061733"></a>

PQ向客户提供一系列专业图像质量调试工具（以下简称PQTools），包括方便的在线调试工具（Tuning Tool），连接单板后可以直接进行ISP等各模块的参数调节，同时通过实时预览点播（Stream）观看设置完参数后的效果；还针对常用调试的场景提供各类数据分析等（Analysis Tool），为客户提供更客观的分析。
...
-   **[软硬件需求](#ZH-CN_TOPIC_0000002498141768)**  

-   **[物理链路连接](#ZH-CN_TOPIC_0000002530221609)**  

-   **[PQTools发布包目录说明](#ZH-CN_TOPIC_0000002498141840)**  

-   **[Linux系统下板端软件的安装与运行](#ZH-CN_TOPIC_0000002530221763)**  
...
-   软件需求
    ...
    使用ISP标定、自动对焦参数仿真、PQTools Stitching Tool前，请下载Python 3.9.2安装包（64位）
...
-   **[SS928V100\_PQ\_Vx.x.x.x.tgz](#ZH-CN_TOPIC_0000002498301738)**  

-   **[SS928V100\_ext\_api\_Vx.x.x.x.tgz](#ZH-CN_TOPIC_0000002530221767)**  
...
-   **[欢迎界面](#ZH-CN_TOPIC_0000002498301740)**  

-   **[工具主界面](#ZH-CN_TOPIC_0000002530061641)**  

-   **[常用操作](#ZH-CN_TOPIC_0000002530061749)**  
...
以上操作执行完毕后，点击“OK”按钮，工具将读取选定的模板生成调试表，并自动建立计算机与单板间的网络连接。若网络连接成功，工具还将自动从板端读取所有调试项的值。若串口连接成功，工具只会自动读取工具当前显示页面的调试项的值。
...
-   **[新建调试表](#ZH-CN_TOPIC_0000002498301748)**  

-   **[保存调试数据文件](#ZH-CN_TOPIC_0000002498301818)**  

-   **[打开调试数据文件](#ZH-CN_TOPIC_0000002498141846)**  

-   **[撤销与重做](#ZH-CN_TOPIC_0000002530221717)**  

-   **[打开外挂插件/外挂程序](#ZH-CN_TOPIC_0000002498301780)**  

-   **[连接单板](#ZH-CN_TOPIC_0000002498141806)**  

-   **[断开与单板的连接](#ZH-CN_TOPIC_0000002530061643)**  

-   **[工具调试表设置](#ZH-CN_TOPIC_0000002498301774)**  

-   **[工具版本号查看](#ZH-CN_TOPIC_0000002498141776)**  
...
-   **[在线调试界面及功能说明](#ZH-CN_TOPIC_0000002498301816)**  

-   **[ISP标定工具](#ZH-CN_TOPIC_0000002498301800)**  

-   **[高级功能](#ZH-CN_TOPIC_0000002498141762)**  

-   **[分析工具界面及功能说明](#ZH-CN_TOPIC_0000002530221651)**  

-   **[其他辅助工具使用说明](#ZH-CN_TOPIC_0000002498141834)**  

-   **[参数详细说明](#ZH-CN_TOPIC_0000002498141708)**  

## 在线调试界面及功能说明<a name="ZH-CN_TOPIC_0000002498301816"></a>

-   **[调试结构界面](#ZH-CN_TOPIC_0000002498301768)**  

-   **[读写通路设置](#ZH-CN_TOPIC_0000002530061753)**  

-   **[寄存器/算法参数调整](#ZH-CN_TOPIC_0000002530221725)**  

-   **[调试数据的批量读写与自动写入](#ZH-CN_TOPIC_0000002530061755)**  

-   **[曲线可视化调试](#ZH-CN_TOPIC_0000002498141854)**  

-   **[3DNR可视化调试](#ZH-CN_TOPIC_0000002530061689)**  

-   **[FPN矫正](#ZH-CN_TOPIC_0000002530061787)**  
...
-   **[寄存器/算法参数的查看与修改](#ZH-CN_TOPIC_0000002498301822)**  

-   **[浮点形式变换](#ZH-CN_TOPIC_0000002498141802)**  

-   **[从板端读取数据](#ZH-CN_TOPIC_0000002530221695)**  

-   **[将数据写入到板端](#ZH-CN_TOPIC_0000002530221765)**  

-   **[数据的暂存与恢复](#ZH-CN_TOPIC_0000002498141858)**  

-   **[数据的显示方式转换](#ZH-CN_TOPIC_0000002530221715)**  

-   **[物理/虚拟寄存器的添加与调试](#ZH-CN_TOPIC_0000002530221723)**  
...
<td class="cellrowborder" valign="top" width="21%" headers="mcps1.2.4.1.2 "><p id="p348mcpsimp"><a name="p348mcpsimp"></a><a name="p348mcpsimp"></a>参数在0和1之间取值</p>
</td>
...
-   **[通用曲线功能说明](#ZH-CN_TOPIC_0000002530221719)**  

-   **[Gamma可视化调试](#ZH-CN_TOPIC_0000002530061799)**  

-   **[DRC可视化调试](#ZH-CN_TOPIC_0000002498301766)**  

-   **[CLUT可视化调试](#ZH-CN_TOPIC_0000002530221677)**  

-   **[Sharpen可视化调试](#ZH-CN_TOPIC_0000002498301812)**  

-   **[CA可视化调试](#ZH-CN_TOPIC_0000002530221733)**  

-   **[LDCI可视化调试](#ZH-CN_TOPIC_0000002498301742)**  

-   **[Dehaze可视化调试](#ZH-CN_TOPIC_0000002530221663)**  

-   **[MCF可视化调试](#ZH-CN_TOPIC_0000002530221687)**  

-   **[PreGamma可视化调试](#ZH-CN_TOPIC_0000002498141748)**  

-   **[3DNR曲线可视化调试](#ZH-CN_TOPIC_0000002530221605)**  

-   **[BNR曲线可视化调试](#ZH-CN_TOPIC_0000002498141860)**  

-   **[MeshShading曲线可视化调试](#ZH-CN_TOPIC_0000002498141812)**  

#### 通用曲线功能说明<a name="ZH-CN_TOPIC_0000002530221719"></a>

-   **[曲线的基本调整方法](#ZH-CN_TOPIC_0000002498301746)**  

-   **[曲线的高级控制](#ZH-CN_TOPIC_0000002530061789)**  
...
-   **[DRC使能](#ZH-CN_TOPIC_0000002530061705)**  

-   **[DRC色调映射曲线调试](#ZH-CN_TOPIC_0000002530221729)**  

-   **[DRC色调TM曲线调试](#ZH-CN_TOPIC_0000002498301828)**  

-   **[饱和度修正曲线调试](#ZH-CN_TOPIC_0000002530061747)**  

-   **[局部细节回叠曲线](#ZH-CN_TOPIC_0000002530061719)**  
...
-   **[CLUT在线调优基本原理](#ZH-CN_TOPIC_0000002498141838)**  

-   **[Cap Image Online功能](#ZH-CN_TOPIC_0000002498301660)**  

-   **[HSV可视化界面调优](#ZH-CN_TOPIC_0000002530221705)**  

-   **[RGB对调优](#ZH-CN_TOPIC_0000002530061723)**  
...
1.  选择Zone0，在捕获图像上通过画框或者取点方式取RGB对的输入，同时在左侧HSV色彩空间显示源的位置，在右侧的源和目标映射区域，显示源和目标的RGB值、HSV值（目标色默认值与源相同）。
    ...
    **图 1**  RGB对调优<a name="fig9119125412416"></a>  
    ![](figures/RGB对调优.png "RGB对调优")

2.  设置Zone0的目标值。支持通过手动输入或者按上下键方式设定目标RGB值或HSV值。源、目标的RGB和HSV是对应的，调整目标RGB值，HSV会自动更新；调整目标HSV值，RGB会自动更新。

    **图 2**  设置目标值<a name="fig209864541859"></a>  
    ![](figures/设置目标值.png "设置目标值")

3.  点击Use按键，左侧HSV图根据用户期望调整的方向，调整HSV结点位置。

    **图 3**  调试生效<a name="fig1489613133612"></a>  
    ![](figures/调试生效.png "调试生效")
...
5.  修改目标值，继续对蓝色块进行调优。
    ...
    **图 5**  Zone0蓝色再次调整目标值<a name="fig105304919716"></a>  
    ![](figures/Zone0蓝色再次调整目标值.png "Zone0蓝色再次调整目标值")
...
8.  Bright Exp参数对应RGB映射对在亮度维度的范围，取值越大，亮度维度被调整的结点越多。希望亮、暗区域也进行色彩调整时，可适当调大Bright Exp范围，但也会一定程度增大暗区的噪声。
    ...
    **图 6**  RGB对调试相关参数<a name="fig14679541715"></a>  
    ![](figures/RGB对调试相关参数.png "RGB对调试相关参数")

9.  完成Zone0 RGB对的调节后，可选择Zone1，继续其他颜色的调优。要求按顺序选择Zone。

    **图 7**  多个RGB对调试<a name="fig81594253819"></a>  
    ![](figures/多个RGB对调试.png "多个RGB对调试")
...
10. 完成调试目标后，通过Export HSV按钮，可保存当前的RGB对调试设置和HSV映射表，后续可通过Import HSV基于历史调优结果继续。离线Clut标定工具通过Import RGB对方式也可以导入该结果，通过离线标定工具进行Clut调优。用户可比较2个工具的标定结果做选择。
    ...
    **图 8**  离线Clut工具导入在线RGB对，进行Clut Calibration<a name="fig1721771914918"></a>  
    ![](figures/离线Clut工具导入在线RGB对-进行Clut-Calibration.png "离线Clut工具导入在线RGB对-进行Clut-Calibration")
...
-   **[Sharpen使能](#ZH-CN_TOPIC_0000002498301824)**  

-   **[Sharpen Luma Weight曲线调试](#ZH-CN_TOPIC_0000002498141790)**  

-   **[Sharpen Texture Strength曲线调试](#ZH-CN_TOPIC_0000002498141758)**  

-   **[Sharpen Edge Strength曲线调试](#ZH-CN_TOPIC_0000002498141810)**  

-   **[YUVsharpen曲线调试](#ZH-CN_TOPIC_0000002530061805)**  
...
-   **[CA使能](#ZH-CN_TOPIC_0000002498141744)**  

-   **[CA曲线调试](#ZH-CN_TOPIC_0000002498141842)**  

-   **[Color Palette功能](#ZH-CN_TOPIC_0000002530221773)**  
...
-   **[LDCI使能](#ZH-CN_TOPIC_0000002530221669)**  

-   **[LDCI LPF Coef曲线调试](#ZH-CN_TOPIC_0000002498301658)**  

-   **[LDCI HePosWgt曲线调试](#ZH-CN_TOPIC_0000002530221777)**  

-   **[LDCI HeNegWgt曲线调试](#ZH-CN_TOPIC_0000002530061759)**  
...
**图 1**  LDCI LPF Coef曲线调试界面<a name="fig6316577108"></a>  
![](figures/LDCI-LPF-Coef曲线调试界面.png "LDCI-LPF-Coef曲线调试界面")
...
**图 1**  LDCI HePosWgt曲线调试界面<a name="fig677452812101"></a>  
![](figures/LDCI-HePosWgt曲线调试界面.png "LDCI-HePosWgt曲线调试界面")
...
-   **[Dehaze使能](#ZH-CN_TOPIC_0000002530221759)**  

-   **[Dehaze曲线调试](#ZH-CN_TOPIC_0000002530061803)**  

##### Dehaze使能<a name="ZH-CN_TOPIC_0000002530221759"></a>

**图 1**  Dehaze寄存器设置界面<a name="fig129221247141015"></a>  
![](figures/Dehaze寄存器设置界面.png "Dehaze寄存器设置界面")
...
共有4个页签，UV曲线仅Alpha页签支持可调，其余3条曲线LF、MF、HF，4个页签都支持可调。
...
点击“Save ShadingLut Data File”按钮，生成一个默认文件名为alg\_lsc\_calib\_info.h的文件，文件中保存的数据按照结构体格式，保存了Shading Lut Attr结构体中的x\_grid\_width，y\_grid\_width和lsc\_gain\_lut的值。
...
-   Insert Data Set：在所选数据集的下方插入一个新的数据集，若所选模式为自动模式，则新数据集的ISO值与所选数据集相同；
...
FPN矫正功能使用前必须优先进行标定操作生成矫正用数据，工具可以通过配置板端版本路径中的config.cfg文件bSaveFPN来决定是否将标定产生的raw数据保存成文件。不使能时，保存在工具申请的内存中。
...
-   **[概述](#ZH-CN_TOPIC_0000002498301718)**  

-   **[标定工具的界面与基本操作](#ZH-CN_TOPIC_0000002530061695)**  

-   **[黑电平的标定](#ZH-CN_TOPIC_0000002498301714)**  

-   **[RGBIR标定工具](#ZH-CN_TOPIC_0000002498141850)**  

-   **[NR标定](#ZH-CN_TOPIC_0000002498301698)**  

-   **[MLSC标定](#ZH-CN_TOPIC_0000002530221747)**  

-   **[ACS标定](#ZH-CN_TOPIC_0000002530061701)**  

-   **[AWB标定](#ZH-CN_TOPIC_0000002498301720)**  

-   **[CCM标定](#ZH-CN_TOPIC_0000002530061663)**  

-   **[CLUT标定](#ZH-CN_TOPIC_0000002498301776)**  

-   **[DynaBLC标定](#ZH-CN_TOPIC_0000002498141784)**  
...
-   **[设置RAW基本属性](#ZH-CN_TOPIC_0000002498141702)**  

-   **[导入RAW文件](#ZH-CN_TOPIC_0000002530061791)**  

-   **[标定配置保存导入](#ZH-CN_TOPIC_0000002530061757)**  
...
-   **[黑电平标定基本原理](#ZH-CN_TOPIC_0000002530221749)**  

-   **[黑电平标定支持的模式](#ZH-CN_TOPIC_0000002530221745)**  

-   **[黑电平标定序列采集要求](#ZH-CN_TOPIC_0000002530221665)**  

-   **[黑电平标定步骤](#ZH-CN_TOPIC_0000002530061711)**  

-   **[黑电平标定结果说明](#ZH-CN_TOPIC_0000002498301672)**  
...
-   **[RGBIR标定原理](#ZH-CN_TOPIC_0000002498301782)**  

-   **[RAW图像采集步骤](#ZH-CN_TOPIC_0000002498141742)**  

-   **[RGBIR标定界面与功能](#ZH-CN_TOPIC_0000002530061777)**  

-   **[RGBIR标定的操作流程](#ZH-CN_TOPIC_0000002530221737)**  

-   **[导入RAW文件并选定24色区域](#ZH-CN_TOPIC_0000002530221659)**  

-   **[进行标定](#ZH-CN_TOPIC_0000002498141764)**  

-   **[导出IR标定结果](#ZH-CN_TOPIC_0000002530061649)**  

-   **[将标定结果发送至板端](#ZH-CN_TOPIC_0000002498301820)**  

-   **[将RGBIR4x4 Pattern的Raw转换为Bayer格式](#ZH-CN_TOPIC_0000002530061703)**  
...
-   **[NR标定基本原理](#ZH-CN_TOPIC_0000002498141828)**  

-   **[NR标定模式介绍](#ZH-CN_TOPIC_0000002498301792)**  

-   **[NR标定序列采集要求](#ZH-CN_TOPIC_0000002530221699)**  

-   **[NR标定工具界面介绍](#ZH-CN_TOPIC_0000002498301670)**  

-   **[NR标定步骤](#ZH-CN_TOPIC_0000002530061797)**  

-   **[NR标定结果的显示和导出](#ZH-CN_TOPIC_0000002498141756)**  

-   **[NR标定结果说明](#ZH-CN_TOPIC_0000002530221643)**  

-   **[NR标定结果验证](#ZH-CN_TOPIC_0000002498301762)**  

-   **[NR标定结果评分](#ZH-CN_TOPIC_0000002498141714)**  

-   **[K Curve To Header使用说明](#ZH-CN_TOPIC_0000002530221613)**  
...
2.  将色卡固定在灯箱里面，灯箱照度保持在400lux左右，保持照度均匀。将镜头固定，调整镜头与色卡的距离，使得拍摄到的色卡覆盖整个成像屏幕的1/2左右，如[图1](#_toc51692533)所示。
3.  ISO设置：
...
标定结束后，工具将显示标定出的ISO/K曲线图，如[图1](#fig18242070113)所示。

**图 1**  NR标定结果<a name="fig18242070113"></a>  
![](figures/NR标定结果.png "NR标定结果")
...
-   **[MLSC标定基本原理](#ZH-CN_TOPIC_0000002498141822)**  

-   **[MLSC标定序列采集要求](#ZH-CN_TOPIC_0000002498301750)**  

-   **[MLSC标定工具界面介绍](#ZH-CN_TOPIC_0000002530061707)**  

-   **[MLSC标定步骤](#ZH-CN_TOPIC_0000002530061645)**  

-   **[MLSC标定结果说明](#ZH-CN_TOPIC_0000002530221769)**  

-   **[使用MLSC标定鱼眼镜头图像](#ZH-CN_TOPIC_0000002530061771)**  

-   **[附录1：MLSC参数说明](#ZH-CN_TOPIC_0000002530221617)**  

-   **[附录2：MLSC标定结果的有效性验证](#ZH-CN_TOPIC_0000002530061779)**  
...
-   **[标定结果导出功能](#ZH-CN_TOPIC_0000002530221673)**  

-   **[使用标定结果校正其他Raw的功能](#ZH-CN_TOPIC_0000002530061687)**  

-   **[将标定结果下发板端的功能](#ZH-CN_TOPIC_0000002530061775)**  
...
-   **[鱼眼镜头标定输入参数](#ZH-CN_TOPIC_0000002498141778)**  

-   **[鱼眼镜头标定步骤](#ZH-CN_TOPIC_0000002498301730)**  

##### 鱼眼镜头标定输入参数<a name="ZH-CN_TOPIC_0000002498141778"></a>

请参考"[鱼眼标定工具](#ZH-CN_TOPIC_0000002530061637)"章节所述，获取鱼眼镜头的Center和Radius参数，并填入控制区中对应位置：
...
-   Method 2
    ...
    当出现偏差较大时，请首先检查黑电平是否配置正确，Bayer Pattern是否配置正确，若还是有偏差，则检查MeshScale设置的增益范围是否够用，不够则需要重新进行标定。

### ACS标定<a name="ZH-CN_TOPIC_0000002530061701"></a>

-   **[ACS标定基本原理](#ZH-CN_TOPIC_0000002498141740)**  

-   **[ACS标定序列采集要求](#ZH-CN_TOPIC_0000002530221657)**  

-   **[ACS标定工具界面介绍](#ZH-CN_TOPIC_0000002530221757)**  

-   **[ACS标定步骤](#ZH-CN_TOPIC_0000002530221697)**  

-   **[ACS标定调试](#ZH-CN_TOPIC_0000002498141760)**  

-   **[ACS标定结果说明](#ZH-CN_TOPIC_0000002498301690)**  
...
-   请首先确认镜头模组的shading衰减曲线在RAW图像上是呈左右和上下对称的，这种情况下采集的环境必须是理想的平坦光源，对于不对称的镜头模组，标定的效果会不太理想，同时影响后续的产线标定。
...
-   为了保证在多种光源下采集的RAW图的平坦均匀性，有两种方式：
    -   方法一，取一张灰卡，让光源均匀照射在灰卡上，用照度计测量镜头视场内中心与四周的照度，使其差异在5%以内，并拍摄灰卡的RAW文件；
...
-   **[AWB标定基本原理](#ZH-CN_TOPIC_0000002498301724)**  

-   **[AWB标定序列采集要求](#ZH-CN_TOPIC_0000002498301710)**  

-   **[AWB标定工具的界面说明](#ZH-CN_TOPIC_0000002498141738)**  

-   **[AWB标定步骤](#ZH-CN_TOPIC_0000002530221751)**  

-   **[CrCb参数标定步骤](#ZH-CN_TOPIC_0000002530221713)**  

-   **[AWB标定结果说明](#ZH-CN_TOPIC_0000002498141772)**  

-   **[附录：为RAW文件样本勾选白区](#ZH-CN_TOPIC_0000002498141852)**  
...
所有的RAW文件都选择好白区以后，即可进行标定。点击“Calibrate Curve”按钮后，等待一小段时间，标定即可完成。标定完成后，以下的结果会被给出：
...
点击RAW文件配置表（工作区黑色区域）中对应RAW文件在WZ（White Zone）一栏中的按钮，可以打开白区框选对话框，如[图1](#fig14000447252)所示。
...
在图像显示的区域使用鼠标左键，可框选图像中的区域。对于24色卡场景，一般选择20-22色块作为白区；对于实际拍摄的自然场景，选择其中的白色部分。选框时，使色框尽可能大（但需要保证所有像素颜色几乎相同），这样可以使取到的R/G和B/G更加精确，从而得到更准确的标定结果。选定白区后的效果如[图 白区勾选](#fig14851613163610)所示。

**图 2**  白区勾选<a name="fig14851613163610"></a>  
![](figures/白区勾选.png "白区勾选")

选定白区后，左侧的列表会显示选定白区的R/G与B/G比值，显示的序号与右侧选框对应。若选择了不需要的选框，或选框错误，可以在列表中点击对应序号右侧的红叉按钮将其删除。

如[图 白区勾选完毕](#fig20920144172219)所示，请注意如果不同亮度的B/G值差异明显（\>0.1），需要确认黑电平设置是否合理。

选择完毕后点击“Close”按钮关闭白区勾选对话框。工具将自动计算该RAW文件的R/G和B/G的算术平均值，并显示在列表中，并在White Pixel Distribution图表中标示该RAW文件所处的位置。

**图 3**  白区勾选完毕<a name="fig20920144172219"></a>  
![](figures/白区勾选完毕.png "白区勾选完毕")

### CCM标定<a name="ZH-CN_TOPIC_0000002530061663"></a>

-   **[CCM标定工具原理](#ZH-CN_TOPIC_0000002498141750)**  

-   **[CCM标定序列采集需求](#ZH-CN_TOPIC_0000002530221681)**  

-   **[CCM标定工具的界面与功能](#ZH-CN_TOPIC_0000002498301684)**  

-   **[CCM标定步骤](#ZH-CN_TOPIC_0000002530061681)**  

-   **[CCM标定结果说明](#ZH-CN_TOPIC_0000002498301804)**  
...
-   **[显示颜色差异结果](#ZH-CN_TOPIC_0000002530061717)**  

-   **[手动调整](#ZH-CN_TOPIC_0000002498301712)**  

-   **[导出当前标定结果](#ZH-CN_TOPIC_0000002530221631)**  

-   **[导出全部标定结果](#ZH-CN_TOPIC_0000002530061699)**  

-   **[记录功能](#ZH-CN_TOPIC_0000002530061709)**  

-   **[标定结果下发到板端](#ZH-CN_TOPIC_0000002530221627)**  

-   **[附录1：选择24色区域](#ZH-CN_TOPIC_0000002530221653)**  

-   **[附录2：配置标定参数](#ZH-CN_TOPIC_0000002530221753)**  
...
测量结果显示RAW数据经过当前CCM参数，得到的源图像与LAB Customization中设定的目标图像的差异。一般来说，源图像的圆形和目标图像的方形会比较接近。用户可以不断调节方形的位置来引导CCM参数的标定。
...
-   **[CLUT标定基本原理](#ZH-CN_TOPIC_0000002530061685)**  

-   **[CLUT标定工具界面与功能](#ZH-CN_TOPIC_0000002498301686)**  

-   **[CLUT标定校正步骤](#ZH-CN_TOPIC_0000002530221671)**  

-   **[CLUT标定结果说明](#ZH-CN_TOPIC_0000002498301732)**  
...
-   **[保存标定参数](#ZH-CN_TOPIC_0000002498301682)**  

-   **[将标定结果发送至板端](#ZH-CN_TOPIC_0000002498301706)**  

-   **[附录1：采集数据的要求](#ZH-CN_TOPIC_0000002498301806)**  

-   **[附录2：加载文件](#ZH-CN_TOPIC_0000002498141804)**  

-   **[附录3：图像参数区设置](#ZH-CN_TOPIC_0000002530221655)**  

-   **[附录4：RGB对生成](#ZH-CN_TOPIC_0000002530221633)**  

-   **[附录5：整理RGB对](#ZH-CN_TOPIC_0000002498141752)**  
...
-   “CCM Matrix”：
    ...
    通过Load CCM按钮导入当前ISP使用的CCM参数，选择已保存的CCM标定数据文件，即可导入已标定的CCM 10进制定点数据到表格中。当输入图像是RAW数据的时候，会使用这里的CCM参数。ISP Calibration Tool的CCM标定结果可以直接导入。同时CLUT工具也支持标定结果的自动解析，可将10进制或16进制CCM数据直接解析并显示成10进制数据（不支持Double类型数据）。也可以导入PQTools界面中，AWB Info处导出的当前板端使用的CCM参数。
...
**图 2**  CLUT标定生成<a name="fig851415511216"></a>  
![](figures/CLUT标定生成.png "CLUT标定生成")
...
-   **[标定基本原理](#ZH-CN_TOPIC_0000002498141816)**  

-   **[DynaBLC 采集要求](#ZH-CN_TOPIC_0000002498141826)**  

-   **[DynaBLC 工具界面介绍](#ZH-CN_TOPIC_0000002498301726)**  

-   **[DynaBLC 标定步骤](#ZH-CN_TOPIC_0000002498141736)**  
...
-   抓raw数据时，Again、Dgain成倍数增加。先增加Again，再增加Dgain。不调节ISPDgain。从iso100开始，每增加一倍Again或Dgain值，采集一个该增益下对应ISO的raw数据。直到Again，Dgain都为最大值。此增益下的ISO为最后一档ISO。如[图 ISO增益表](#fig27917328115)所示
...
-   **[寄存器修改器](#ZH-CN_TOPIC_0000002498301694)**  

-   **[参数的导出导入](#ZH-CN_TOPIC_0000002498141722)**  

-   **[通信日志](#ZH-CN_TOPIC_0000002530061661)**  

-   **[I2C读写工具](#ZH-CN_TOPIC_0000002530221721)**  

-   **[SPI读写工具](#ZH-CN_TOPIC_0000002498301708)**  
...
-   **[颜色分析工具](#ZH-CN_TOPIC_0000002530061739)**  

-   **[原始数据（RAW）和YUV分析工具](#ZH-CN_TOPIC_0000002498141734)**  

-   **[3A 分析工具](#ZH-CN_TOPIC_0000002498141766)**  

-   **[自动对焦参数仿真工具使用说明](#ZH-CN_TOPIC_0000002498301790)**  

### 颜色分析工具<a name="ZH-CN_TOPIC_0000002530061739"></a>

-   **[工具界面](#ZH-CN_TOPIC_0000002530221679)**  

-   **[选择数据来源](#ZH-CN_TOPIC_0000002530221641)**  

-   **[使用24色颜色对比功能](#ZH-CN_TOPIC_0000002530061667)**  

-   **[自定义标准色](#ZH-CN_TOPIC_0000002498141718)**  

-   **[查看RGB统计直方图](#ZH-CN_TOPIC_0000002530061713)**  

-   **[测算图片任意区域的信噪比SNR](#ZH-CN_TOPIC_0000002530061679)**  
...
-   CIE2000算法得出的不考虑亮度的L\*a\*b\*色彩空间距离值ΔC\*00（含修正饱和度后的值），以及考虑亮度的L\*a\*b\*色彩空间距离值ΔE\*00（图像是sRGB色彩空间时，选择CIE2000；图像是Rec.2020 Full色彩空间时，选择CIE2000\_BT2020）。
-   白平衡误差分析
-   取样颜色的RGB平均值
...
拖动红色方框的边角，使得红色方框准确落在24色色块范围内，可达到最佳的颜色取样效果。使用对话框下方的Color Block Size选项，可以调整红色方框的水平和垂直大小。红色方框应尽量多地覆盖色块中的像素（但需要保证每个红色方框落在单独的色块内，同一方框内所有像素颜色相同），这样可以更精确地取色。

调整完毕后点击“OK”，这时界面上就会显示出颜色分析结果了，如[图3](#fig781392181214)所示。

**图 3**  显示颜色分析结果<a name="fig781392181214"></a>  
![](figures/显示颜色分析结果.png "显示颜色分析结果")
...
-   点击Import From右侧的“Image File”按钮，用户可以自选一张标准色卡的图片，框定24色卡区域后，将其用作标准色卡。这时工具将根据用户框定的24色卡区域自动求取色卡的L\*a\*b\*值。
...
-   **[工具界面](#ZH-CN_TOPIC_0000002530221711)**  

-   **[选择数据来源](#ZH-CN_TOPIC_0000002530221707)**  

-   **[获取合并后的原始图像数据](#ZH-CN_TOPIC_0000002498141836)**  

-   **[显示亮度统计直方图](#ZH-CN_TOPIC_0000002498301692)**  

-   **[查看分量图像](#ZH-CN_TOPIC_0000002530061655)**  
...
-   **[工具界面](#ZH-CN_TOPIC_0000002498141694)**  

-   **[获取图像与统计数据](#ZH-CN_TOPIC_0000002498141728)**  

-   **[查看AE统计数据](#ZH-CN_TOPIC_0000002498141794)**  

-   **[查看AF统计数据](#ZH-CN_TOPIC_0000002498301758)**  

-   **[查看AWB统计数据](#ZH-CN_TOPIC_0000002530061781)**  

-   **[AWB独立光源点编辑](#ZH-CN_TOPIC_0000002498141720)**  

-   **[应用局部AWB结果至全局AWB](#ZH-CN_TOPIC_0000002498141712)**  
...
之后工具将自动从板端抓取数据，直到用户取消对Capture Image From复选框的勾选。成功从板端抓取数据后，工具会在下方的灰色区域显示图像效果如[图1](#fig4921358163813)所示。
...
-   界面上的Stitch复选框，支持拼接功能。且FE Histogram由多组直方图组成，每组包含1024个数据点。
...
工具支持将某一区间上的AWB结果应用至全局。在区间上点击右键并选择Apply Result to Global（见[图2](#fig632016379191)），即可完成设置。
...
-   **[工具界面](#ZH-CN_TOPIC_0000002498141692)**  

-   **[通过截止频率获取AF滤波系数](#ZH-CN_TOPIC_0000002498301700)**  

-   **[手动配置滤波系数](#ZH-CN_TOPIC_0000002498301764)**  

-   **[设置参考组](#ZH-CN_TOPIC_0000002498141786)**  
...
-   **[抓拍工具使用说明](#ZH-CN_TOPIC_0000002530221635)**  

-   **[RAW实用工具使用说明](#ZH-CN_TOPIC_0000002498301756)**  

-   **[YUV实用工具使用说明](#ZH-CN_TOPIC_0000002530221607)**  

-   **[外接存储设备抓灌说明](#ZH-CN_TOPIC_0000002530221703)**  

-   **[鱼眼标定工具](#ZH-CN_TOPIC_0000002530061637)**  

-   **[LMF转换工具使用说明](#ZH-CN_TOPIC_0000002498301798)**  

-   **[辅助对焦工具使用说明](#ZH-CN_TOPIC_0000002498301752)**  

-   **[PQ Stitching Tool使用说明](#ZH-CN_TOPIC_0000002530061669)**  

-   **[OSD转换工具使用说明](#ZH-CN_TOPIC_0000002498301676)**  

-   **[DIS标定工具使用说明](#ZH-CN_TOPIC_0000002498141726)**  

-   **[Dis Debug陀螺仪工具使用说明](#ZH-CN_TOPIC_0000002498301826)**  

-   **[工具参数联动使用说明](#ZH-CN_TOPIC_0000002530221621)**  
...
-   **[工具界面](#ZH-CN_TOPIC_0000002530061659)**  

-   **[抓取YUV图像数据](#ZH-CN_TOPIC_0000002498141818)**  

-   **[抓取RAW图像数据](#ZH-CN_TOPIC_0000002498301662)**  

-   **[抓取JPEG图像数据](#ZH-CN_TOPIC_0000002498141730)**  

-   **[抓取调试信息](#ZH-CN_TOPIC_0000002530061741)**  
...
12. 在抓取YUV或RAW图像数据时，用户可随时取消抓取。点击“Cancel”按钮，工具会在抓取到下一帧数据后停止进行抓取，并恢复界面可操作状态。但是若工具已经抓取到最后一帧图像数据，则取消会无效，工具还将弹出图像数据保存对话框。
...
-   **[工具界面](#ZH-CN_TOPIC_0000002498141844)**  

-   **[导入RAW数据](#ZH-CN_TOPIC_0000002530221625)**  

-   **[RAW数据的ISPInfo信息](#ZH-CN_TOPIC_0000002530221649)**  

-   **[向板端倒灌RAW图像数据](#ZH-CN_TOPIC_0000002530061761)**  
...
如果导入的RAW文件是在抓拍工具抓拍到的，且以默认文件名保存的（格式形如RAW\_1920x1080\_12bits\_RGGB\_Linear\_XXXXXX），则RAW实用工具可以直接解析这个RAW文件的大小、位宽、模式、分量排序。
...
-   选中：可以直接在列表上点击一行以选中该行的RAW文件。可以使用Ctrl或Shift按钮进行多选；
...
-   **[工具界面](#ZH-CN_TOPIC_0000002530061677)**  

-   **[向板端倒灌YUV图像数据](#ZH-CN_TOPIC_0000002498141780)**  
...
8.  点击“Flush”按钮，停止循环灌包；点击“Cancel”按钮，取消灌YUV。
    ...
    >-   默认提供的ini不支持从VI灌YUV，如需要请参考[ini文件适配](#ZH-CN_TOPIC_0000002530221755)"[说明9](#li5419mcpsimp)："配置ini并重新启动业务。
    >-   “Cancel”功能暂不支持。
    >-   当前支持从VI/VPSS/AVS/VENC模块灌入。
    >-   当前支持两种格式 YUV\_planar420，YUV\_semiplanar420
    >-   对mcf 模块灌入YUV时，要自行确认好对应通路的YUV格式。保证黑白和彩色YUV灌入正确的mcf chn。同时和其他模块不同，mcf 灌YUV需要注意，group/pipe通路默认一般为0，需要根据chn号来设置区分黑白和彩色通路。
...
-   **[抓取图像存储到外接设备](#ZH-CN_TOPIC_0000002530221761)**  

-   **[从存储设备中读取文件灌RAW及YUV](#ZH-CN_TOPIC_0000002498301702)**  

-   **[起业务后自动抓取码流数据](#ZH-CN_TOPIC_0000002498141808)**  
...
-   **[使用CMA方案保存RAW文件到SSD](#ZH-CN_TOPIC_0000002498301678)**  
...
>![](public_sys-resources/icon-notice.gif) **须知：** 
>-   鱼眼标定工具仅支持8bit、sp420两种格式的YUV数据，请勿导入其他格式的YUV数据文件（例如P444，P400等，PQ Capture Tools抓出的sp420 YUV格式可以使用）。
...
1.  边缘椭圆周：工具会根据计算出的鱼眼圆心坐标和半径将鱼眼的椭圆周用红色线条绘制出来。
...
-   **[利用辅助对焦工具进行调焦](#ZH-CN_TOPIC_0000002498141800)**  

-   **[对焦辅助操作](#ZH-CN_TOPIC_0000002498301794)**  

-   **[导入AF配置文件](#ZH-CN_TOPIC_0000002530221623)**  
...
-   **[多路拼接标定功能（Stitch Calibration）](#ZH-CN_TOPIC_0000002498301778)**  

-   **[查找表转换功能（Stitch Conversion）](#ZH-CN_TOPIC_0000002498141710)**  

-   **[拼接颜色差异标定功能（Stitch Color Correction）](#ZH-CN_TOPIC_0000002530221743)**  

-   **[PNG Mask文件转换功能（Stitch Mask Converter）](#ZH-CN_TOPIC_0000002530061727)**  

-   **[多路离线拼接功能（Stitch Preview）](#ZH-CN_TOPIC_0000002530061745)**  

-   **[多路自动精调功能](#ZH-CN_TOPIC_0000002530221739)**  
...
转换结束后，工具将对每个通路生成两个二进制文件，其中文件名中标注mesh的文件为拼接坐标查找表数据文件，而标注poly的文件为拼接有效区域边界坐标的数据文件。点击“Apply to Device”按钮，可以直接将生成的查找表发送到设备上并即时生效。
...
标定后，工具将依据用户选择的标定项来显示标定结果，如[图2](#fig967071151311)所示。

-   若用户标定了亮度拟合曲线，则工具会在拟合曲线参数表中显示拟合参数；
-   若用户标定了CCM，则工具会显示浮点形式的CCM矩阵表格和16进制模式下的CCM矩阵表格。

    **图 2**  拼接颜色校正页面<a name="fig967071151311"></a>  
    ![](figures/拼接颜色校正页面-2.png "拼接颜色校正页面-2")
...
3.  导入标定文件。点击“Open Calib Data File”按钮，导入拼接标定文件，显示拼接文件路径 \(标定文件所需的拼接源数目和实际加载或者抓取的图片路数必须一致\)。
...
-   **[DIS标定基本原理](#ZH-CN_TOPIC_0000002530061751)**  

-   **[DIS标定序列采集要求](#ZH-CN_TOPIC_0000002530061653)**  

-   **[DIS标定工具界面介绍](#ZH-CN_TOPIC_0000002498141824)**  

-   **[DIS标定步骤](#ZH-CN_TOPIC_0000002498141782)**  

-   **[DIS标定结果说明](#ZH-CN_TOPIC_0000002498141798)**  

-   **[LDCV3镜头标定工具界面介绍](#ZH-CN_TOPIC_0000002498141820)**  
...
-   棋盘格需要覆盖至少3种不同的距离，并且这些距离最好是包含最常使用的一个距离；
-   棋盘格需要覆盖不同的角度；
...
需要配置使用的sensor的像素大小（PixelSize），例如2.9000。图像的宽度（ImageWidth），图像的高度（ImageHeight）。
...
-   **[使用要求](#ZH-CN_TOPIC_0000002530061731)**  

-   **[界面介绍](#ZH-CN_TOPIC_0000002530221731)**  

-   **[使用步骤](#ZH-CN_TOPIC_0000002530061793)**  

-   **[结果说明](#ZH-CN_TOPIC_0000002530221685)**  
...
**图 1**  陀螺仪界面<a name="fig6771115016133"></a>  
![](figures/陀螺仪界面.png "陀螺仪界面")
...
**图 1**  显示陀螺仪获取的数据<a name="fig1184816514149"></a>  
![](figures/显示陀螺仪获取的数据.png "显示陀螺仪获取的数据")
...
-   **[参数联动规则](#ZH-CN_TOPIC_0000002530061671)**  

-   **[参数联动列表](#ZH-CN_TOPIC_0000002498301728)**  
...
下面将详细列出界面上各模块参数对应SDK的API函数参考，这些参数说明请参考[表1](#_toc51692651)\~[表54](#_toc51692704)。

>![](public_sys-resources/icon-notice.gif) **须知：** 
>生态版本不支持拼接、MCF相关功能。

-   **[SS928V100参数](#ZH-CN_TOPIC_0000002498301796)**  
...
-   **[工具的参数如何导入导出？](#ZH-CN_TOPIC_0000002530061743)**  

-   **[工具如何替换3A算法？](#ZH-CN_TOPIC_0000002498301810)**  
...
-   **[使用工具导入导出参数](#ZH-CN_TOPIC_0000002530061765)**  

-   **[BIN中ISP保存模块](#ZH-CN_TOPIC_0000002530061795)**  

-   **[使用库导入导出图像质量参数](#ZH-CN_TOPIC_0000002530221615)**  
...
-   **[开放参数](#ZH-CN_TOPIC_0000002498141686)**  

-   **[开放接口](#ZH-CN_TOPIC_0000002530221675)**  

-   **[数据类型](#ZH-CN_TOPIC_0000002530061651)**  

-   **[API参考](#ZH-CN_TOPIC_0000002498301802)**  
...
-   **[PQ\_BIN\_ISP\_S](#ZH-CN_TOPIC_0000002530061773)**  

-   **[PQ\_BIN\_NRX\_S](#ZH-CN_TOPIC_0000002530221709)**  

-   **[PQ\_BIN\_ISP\_EVO\_S](#ZH-CN_TOPIC_0000002530061769)**  

-   **[PQ\_BIN\_MODULE\_S](#ZH-CN_TOPIC_0000002498141796)**  
...
-   **[OT\_PQ\_GetISPDataTotalLen](#ZH-CN_TOPIC_0000002498301666)**  

-   **[OT\_PQ\_GetStructParamLen](#ZH-CN_TOPIC_0000002530061633)**  

-   **[OT\_PQ\_BIN\_ExportBinData](#ZH-CN_TOPIC_0000002498301722)**  

-   **[OT\_PQ\_BIN\_ImportBinData](#ZH-CN_TOPIC_0000002498141704)**  
...
-   **[点播软件的安装与运行](#ZH-CN_TOPIC_0000002498141770)**  

-   **[快速入门](#ZH-CN_TOPIC_0000002498141688)**  

-   **[ini文件适配](#ZH-CN_TOPIC_0000002530221755)**  

-   **[新sensor对接，如何支持？](#ZH-CN_TOPIC_0000002530221693)**  

## 点播软件的安装与运行<a name="ZH-CN_TOPIC_0000002498141770"></a>

-   **[板端软件执行](#ZH-CN_TOPIC_0000002530221775)**  

-   **[PC端软件执行](#ZH-CN_TOPIC_0000002498301664)**  
...
-   **[预览](#ZH-CN_TOPIC_0000002530061697)**  

-   **[录像](#ZH-CN_TOPIC_0000002530061737)**  

-   **[右键功能菜单](#ZH-CN_TOPIC_0000002530061783)**  

-   **[WDR模式切换](#ZH-CN_TOPIC_0000002530061639)**  

-   **[Stitch数据源切换](#ZH-CN_TOPIC_0000002530061631)**  

-   **[录像设置](#ZH-CN_TOPIC_0000002530221667)**  

-   **[Sensor参数设置](#ZH-CN_TOPIC_0000002498301760)**  
...
![](figures/zh-cn_image_0000002530221857.png)\(3\)录像：控制录像的开始与停止。下拉菜单包括录像的开始、停止和设置，如[图2](#fig1350914534258)所示。当视频正常链接的时候，点击下拉菜单录像按钮进行录像。开始录像时录像按钮变为![](figures/zh-cn_image_0000002530061887.png)且下拉菜单变为![](figures/zh-cn_image_0000002498141942.png)。在“\(5\)录像时长”处显示已录像时长。此时当点击下拉列表的停止按钮，停止录像。同时按钮恢复先前状态，“\(5\)录像时长”消失。

### 右键功能菜单<a name="ZH-CN_TOPIC_0000002530061783"></a>

-   **[显示方式](#ZH-CN_TOPIC_0000002498301744)**  

-   **[解码方式](#ZH-CN_TOPIC_0000002530061715)**  

-   **[区域平均亮度统计](#ZH-CN_TOPIC_0000002498141856)**  

-   **[输出图层](#ZH-CN_TOPIC_0000002498141830)**  
...
-   **[使用VLC硬解ittb\_stream](#ZH-CN_TOPIC_0000002530061801)**  
...
-   **[为什么工具连接单板会提示版本不匹配？](#ZH-CN_TOPIC_0000002530221603)**  

-   **[PQTools工具文本文件导入导出异常如何处理](#ZH-CN_TOPIC_0000002530221683)**  

-   **[如何处理低照度场景编码I帧过大无法点播](#ZH-CN_TOPIC_0000002498141788)**  

-   **[如何读取到RC属性或者GopMode属性](#ZH-CN_TOPIC_0000002498301808)**  

-   **[如何解决因内存不够导致的抓/灌RAW/YUV等操作失败](#ZH-CN_TOPIC_0000002530061721)**  

-   **[在使用CLUT标定时，出现文件路径解析错误](#ZH-CN_TOPIC_0000002530061691)**  

-   **[使用非SDK提供的 3A库，如何配置XML可调项](#ZH-CN_TOPIC_0000002530221771)**  

-   **[用户的媒体业务起来后，PQTools工具界面不能调节AE、AWB等参数](#ZH-CN_TOPIC_0000002498301784)**  

-   **[PQTools工具4K分辨率下部分界面显示异常](#ZH-CN_TOPIC_0000002498141774)**  

-   **[PQTools工具灌RAW之后，图像显示异常](#ZH-CN_TOPIC_0000002498301734)**  

-   **[FPN标定无法存raw文件](#ZH-CN_TOPIC_0000002530061735)**  

-   **[8k分辨率ISP工具导入RAW个数受限](#ZH-CN_TOPIC_0000002530061785)**  

-   **[关闭板端业务命令](#ZH-CN_TOPIC_0000002530061725)**  

-   **[PQTools DIS标定工具convert或apply失败的解决方法](#ZH-CN_TOPIC_0000002498301716)**  

-   **[关于隐私保护PQTools工具使用及限制说明](#ZH-CN_TOPIC_0000002498301830)**  

-   **[关于Stitch Preview拼接仿真限制说明](#ZH-CN_TOPIC_0000002530221701)**  

-   **[关于使用工具抓JPEG图像异常](#ZH-CN_TOPIC_0000002530061675)**  
...
低照度场景的RAW经过编码后的I帧远大于正常场景，网络传输buffer和PC端接收码流的buffer受限，不能传输和存储该I帧。
