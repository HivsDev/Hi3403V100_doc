...
-   **[简介](#ZH-CN_TOPIC_0000002408421458)**  

-   **[基本功能](#ZH-CN_TOPIC_0000002408581194)**  

-   **[运行流程](#ZH-CN_TOPIC_0000002442020577)**  
...
-   **[训练后量化与量化感知训练](#ZH-CN_TOPIC_0000002408421514)**  

-   **[工具实现的融合功能](#ZH-CN_TOPIC_0000002441980785)**  

-   **[工具实现的加速优化](#ZH-CN_TOPIC_0000002408421306)**  

### 训练后量化与量化感知训练<a name="ZH-CN_TOPIC_0000002408421514"></a>

-   **[概念介绍](#ZH-CN_TOPIC_0000002408421378)**  

-   **[实现原理](#ZH-CN_TOPIC_0000002408581242)**  
...
**训练后量化**：是指将训练后模型中的权重由float32量化到int8，并通过少量校准数据对数据（activation）进行校准量化。量化过程请参见[训练后量化](#ZH-CN_TOPIC_0000002441980565)。训练后量化不支持多个GPU同时运行。
...
-   **均匀量化**
    ...
    -   如果均匀量化后的模型精度无法满足要求，则需要进行[量化感知训练](#section115212449915)。
...
量化感知训练缺点是较为耗时，同时需要大量数据。量化过程请参见[量化感知训练](#ZH-CN_TOPIC_0000002442020557)。
...
<td class="cellrowborder" valign="top" width="77%" headers="mcps1.2.3.1.2 "><p id="p870mcpsimp"><a name="p870mcpsimp"></a><a name="p870mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408581422">安装AMCT</a>安装Caffe框架的AMCT。</p>
</td>
</tr>
...
-   **[获取软件包](#ZH-CN_TOPIC_0000002441980645)**  

-   **[安装前准备](#ZH-CN_TOPIC_0000002408421266)**  

-   **[安装](#ZH-CN_TOPIC_0000002408421350)**  

-   **[安装后处理](#ZH-CN_TOPIC_0000002442020613)**  
...
-   **[Ubuntu x86系统](#ZH-CN_TOPIC_0000002408581358)**  

### Ubuntu x86系统<a name="ZH-CN_TOPIC_0000002408581358"></a>

-   **[AMCT用户准备](#ZH-CN_TOPIC_0000002408421414)**  

-   **[配置AMCT安装用户权限（可选）](#ZH-CN_TOPIC_0000002441980537)**  

-   **[环境准备](#ZH-CN_TOPIC_0000002442020533)**  

-   **[检查源](#ZH-CN_TOPIC_0000002441980769)**  

-   **[安装依赖](#ZH-CN_TOPIC_0000002408421250)**  

-   **[上传软件包](#ZH-CN_TOPIC_0000002408421438)**  
...
-   **[patch安装](#ZH-CN_TOPIC_0000002442020597)**  

-   **[环境变量设置](#ZH-CN_TOPIC_0000002441980525)**  
...
-   **[proto合并前提条件](#ZH-CN_TOPIC_0000002441980609)**  

-   **[安装步骤](#ZH-CN_TOPIC_0000002408581378)**  
...
-   **[sample代码解析](#ZH-CN_TOPIC_0000002408581398)**  

-   **[均匀量化](#ZH-CN_TOPIC_0000002408581338)**  

-   **[非均匀量化](#ZH-CN_TOPIC_0000002408581402)**  

-   **[量化配置](#ZH-CN_TOPIC_0000002408421466)**  
...
-   **[解析前提](#ZH-CN_TOPIC_0000002441980709)**  

-   **[AMCT使用流程](#ZH-CN_TOPIC_0000002408581162)**  

-   **[用户修改部分](#ZH-CN_TOPIC_0000002408581430)**  
...
-   **[分类网络模型量化](#ZH-CN_TOPIC_0000002441980777)**  

-   **[检测网络模型量化](#ZH-CN_TOPIC_0000002408581306)**  

-   **[convert\_model接口量化示例](#ZH-CN_TOPIC_0000002442020493)**  

-   **[MNIST网络模型量化](#ZH-CN_TOPIC_0000002441980693)**  

### 分类网络模型量化<a name="ZH-CN_TOPIC_0000002441980777"></a>

-   **[量化前提](#ZH-CN_TOPIC_0000002408581202)**  

-   **[量化示例](#ZH-CN_TOPIC_0000002441980557)**  

-   **[模型精度测试](#ZH-CN_TOPIC_0000002408581178)**  
...
2.  量化结果说明。
    ...
    -   tmp：量化过程中产生的文件，包括：
        -   config.json：描述了如何对模型中的每一层进行量化。如果量化脚本所在目录下已经存在量化配置文件，则再次调用create\_quant\_config接口时，如果新生成的量化配置文件与已有的文件同名，则会覆盖已有的量化配置文件，否则生成新的量化配置文件。实际量化过程中，如果量化后的模型推理精度不满足要求，用户可以修改config.json文件，量化配置文件内容、修改原则以及参数解释请参见[量化示例](#ZH-CN_TOPIC_0000002441980557)。
...
由于[量化示例](#ZH-CN_TOPIC_0000002441980557)进行的推理和量化校准的过程都是基于自带的图片数据集进行的，量化结果仅用于验证量化模型是否成功，不能够作为量化后模型精度验证标准。本章节给出基于ImageNet标准数据集进行量化前后网络精度验证测试的详细步骤。
...
-   量化前精度测试。
    ...
    参数解释请参见[表1](#table1494163204718)，若出现如下信息则说明执行成功。
...
-   **[量化前提](#ZH-CN_TOPIC_0000002441980737)**  

-   **[量化示例](#ZH-CN_TOPIC_0000002442020641)**  

-   **[模型精度测试](#ZH-CN_TOPIC_0000002441980585)**  

#### 量化前提<a name="ZH-CN_TOPIC_0000002441980737"></a>

**模型准备<a name="section826283710295"></a>**

请参见[模型准备](#section74542347187)。

如果使用FasterRCNN模型，则执行步骤[环境初始化](#section191821420432)时会将模型自动下载到本地，本手册以该场景下的模型为例进行说明，用户也可以自行准备模型。

**数据集准备<a name="section1054444984120"></a>**

请参见[数据集准备](#section269618101191)。

本手册以FasterRCNN模型自带的数据集为例进行说明，[环境初始化](#section191821420432)时会生成相应数据集。

**校准集准备<a name="section16317478429"></a>**

请参见[校准集准备](#section1584931201915)。
...
1.  对原始网络模型进行预测试，检测原始模型是否可以在Caffe环境中正常运行。
    ...
    参数解释如[表1](#table1494163204718)所示。
...
3.  量化结果展示。
    ...
    -   config.json：描述了如何对模型中的每一层进行量化。如果量化脚本所在目录下已经存在量化配置文件，则再次调用create\_quant\_config接口时，如果新生成的量化配置文件与已有的文件同名，则会覆盖已有的量化配置文件，否则生成新的量化配置文件。
        ...
        实际量化过程中，如果量化后的模型推理精度不满足要求，用户可以修改config.json文件，量化配置文件内容、修改原则以及参数解释请参见[量化配置](#ZH-CN_TOPIC_0000002408421466)。
...
由于[量化示例](#ZH-CN_TOPIC_0000002442020641)进行的推理和量化校准的过程都是基于自带的图片数据集进行的，量化结果仅用于验证量化模型是否成功，不能够作为量化后模型精度验证标准。本章节给出基于VOC2007标准数据集进行量化前后网络精度验证测试的详细步骤。
...
环境初始化完成后，除了重新生成[环境初始化](#section191821420432)中的文件外，还会额外在amct\_caffe\_faster\_rcnn\_sample/datasets目录生成**VOCdevkit**数据集文件。
...
-   **[量化前提](#ZH-CN_TOPIC_0000002441980545)**  

-   **[量化示例](#ZH-CN_TOPIC_0000002408421446)**  

#### 量化前提<a name="ZH-CN_TOPIC_0000002441980545"></a>

-   模型、数据集、校准集的准备动作请参见[量化前提](#ZH-CN_TOPIC_0000002408581202)。
-   量化因子：
...
1.  对原始网络模型进行预测试，检测原始模型是否可以在Caffe环境中正常运行。
    ...
    其中，**_ _--record\_file RECORD\_FILE**参数表示量化因子记录文件\(.txt\)路径，该场景下必填，其余参数解释请参见[表1](#table1494163204718)。
...
-   **[量化前提](#ZH-CN_TOPIC_0000002442020389)**  

-   **[量化示例](#ZH-CN_TOPIC_0000002441980717)**  
...
2.  量化成功后，界面会显示量化后精度仿真模型的推理结果、以及量化前和量化后精度测试结果，在量化后模型的同级目录下生成量化日志文件夹amct\_log、量化结果文件夹results、量化中间结果文件夹tmp等：
    -   amct\_log：记录了工具的日志信息，包括量化过程的日志信息amct\_caffe.log。
    -   tmp：量化过程中产生的文件，包括：
        -   config.json：描述了如何对模型中的每一层进行量化。如果量化脚本所在目录下已经存在量化配置文件，则再次调用create\_quant\_config接口时，如果新生成的量化配置文件与已有的文件同名，则会覆盖已有的量化配置文件，否则生成新的量化配置文件。实际量化过程中，如果量化后的模型推理精度不满足要求，用户可以修改config.json文件，量化配置文件内容、修改原则以及参数解释请参见[量化配置](#ZH-CN_TOPIC_0000002408421466)。
        -   中间模型文件modified\_model.prototxt、modified\_model.caffemodel
...
-   **[简介](#ZH-CN_TOPIC_0000002408581390)**  

-   **[量化示例](#ZH-CN_TOPIC_0000002442020465)**  
...
2.  执行量化脚本，对原始网络模型进行量化（如果模型没下载，参考[量化前提](#ZH-CN_TOPIC_0000002408581202)下载模型）。
...
3.  量化成功后，在量化后模型的同级目录下重新生成量化日志文件夹amct\_log、量化结果文件夹results、量化中间结果文件夹tmp：
    -   amct\_log：记录了工具的日志信息，包括量化过程的日志信息amct\_caffe.log。
    -   tmp：量化过程中产生的文件，包括:
        -   config.json：描述了如何对模型中的每一层进行量化。如果量化脚本所在目录下已经存在量化配置文件，则再次调用[create\_quant\_config](#ZH-CN_TOPIC_0000002441980797)  接口时，如果新生成的量化配置文件与已有的文件同名，则会覆盖已有的量化配置文件，否则生成新的量化配置文件。实际量化过程中，如果量化后的模型推理精度不满足要求，用户可以修改config.json文件，量化配置文件内容、修改原则以及参数解释请参见[量化配置](#ZH-CN_TOPIC_0000002408421466)。
...
-   **[基本介绍](#ZH-CN_TOPIC_0000002442020377)**  

-   **[参数配置说明](#ZH-CN_TOPIC_0000002442020421)**  

-   **[参数调优说明](#ZH-CN_TOPIC_0000002408421482)**  
...
-   **[量化示例](#ZH-CN_TOPIC_0000002408421242)**  

-   **[量化配置](#ZH-CN_TOPIC_0000002442020633)**  

## 量化示例<a name="ZH-CN_TOPIC_0000002408421242"></a>

-   **[量化前提](#ZH-CN_TOPIC_0000002408421506)**  

-   **[量化步骤](#ZH-CN_TOPIC_0000002408421426)**  
...
2.  执行resnet50网络模型的量化感知训练。
    ...
    部分参数解释请参见[表1](#table1494163204718)，其余参数解释请参见[表1](#_Ref77062152)。
...
-   **[简介](#ZH-CN_TOPIC_0000002408421286)**  

-   **[参数配置说明](#ZH-CN_TOPIC_0000002441980677)**  

-   **[参数调优说明](#ZH-CN_TOPIC_0000002442020369)**  
...
-   **[公共接口](#ZH-CN_TOPIC_0000002441980753)**  

-   **[训练后量化](#ZH-CN_TOPIC_0000002408421274)**  

-   **[量化感知训练](#ZH-CN_TOPIC_0000002408421498)**  

## 公共接口<a name="ZH-CN_TOPIC_0000002441980753"></a>

-   **[set\_gpu\_mode](#ZH-CN_TOPIC_0000002442020381)**  

-   **[set\_cpu\_mode](#ZH-CN_TOPIC_0000002408421398)**  

-   **[uninplace\_model](#ZH-CN_TOPIC_0000002442020585)**  
...
-   **[create\_quant\_config](#ZH-CN_TOPIC_0000002441980797)**  

-   **[init](#ZH-CN_TOPIC_0000002441980657)**  

-   **[weights\_quantize\_model](#ZH-CN_TOPIC_0000002408421334)**  

-   **[activation\_quantize\_model](#ZH-CN_TOPIC_0000002408581438)**  

-   **[save\_model](#ZH-CN_TOPIC_0000002442020453)**  

-   **[convert\_model](#ZH-CN_TOPIC_0000002408581370)**  
...
-   **[create\_quant\_retrain\_config](#ZH-CN_TOPIC_0000002408581290)**  

-   **[create\_quant\_retrain\_model](#ZH-CN_TOPIC_0000002442020397)**  

-   **[save\_quant\_retrain\_model](#ZH-CN_TOPIC_0000002441980725)**  
...
-   **[使用命令行方式安装Caffe环境失败](#ZH-CN_TOPIC_0000002408581186)**  

-   **[安装python3-tk时提示错误信息](#ZH-CN_TOPIC_0000002408581322)**  

-   **[执行proto合并时提示ERROR信息](#ZH-CN_TOPIC_0000002442020621)**  

-   **[量化执行过程中提示“RuntimeError: Cannot find scale\_d of layer '\*\*' in record file”](#ZH-CN_TOPIC_0000002441980533)**  

-   **[检测网络量化时提示"UserWarning: Matplotlib is currently using agg, which is a non-GUI backend, so cannot show the figure."](#ZH-CN_TOPIC_0000002442020565)**  

-   **[校准执行过程中提示“IfmrQuantWithOffset scale is illegal"](#ZH-CN_TOPIC_0000002441980629)**  
...
-   **[支持量化的算子列表](#ZH-CN_TOPIC_0000002408581274)**  

-   **[sample目录及patch目录说明](#ZH-CN_TOPIC_0000002408421474)**  

-   **[proto合并原理](#ZH-CN_TOPIC_0000002408581258)**  

-   **[量化因子记录文件说明](#ZH-CN_TOPIC_0000002441980745)**  

-   **[训练后量化简易量化配置文件说明](#ZH-CN_TOPIC_0000002441980761)**  

-   **[安装Python3.7.5（Ubuntu）](#ZH-CN_TOPIC_0000002408581350)**  
...
-   **[量化因子记录文件格式说明](#ZH-CN_TOPIC_0000002408581174)**  

-   **[量化因子说明](#ZH-CN_TOPIC_0000002408581218)**  
