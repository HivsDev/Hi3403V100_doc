...
-   **[简介](#ZH-CN_TOPIC_0000002442022477)**  

-   **[功能](#ZH-CN_TOPIC_0000002442022485)**  

-   **[约束与说明](#ZH-CN_TOPIC_0000002442022473)**  
...
-   **[数据格式要求](#ZH-CN_TOPIC_0000002441982629)**  

-   **[准备离线模型dump数据文件（ACL接口方式）](#ZH-CN_TOPIC_0000002408423330)**  

-   **[准备Caffe模型npy数据文件](#ZH-CN_TOPIC_0000002441982649)**  
...
-   **[前提条件](#ZH-CN_TOPIC_0000002441982641)**  

-   **[dump数据](#ZH-CN_TOPIC_0000002408423338)**  
...
2.  <a name="li3175123813116"></a>在查出的目录下修改acl.json文件（如不存在，则需要新建，建议放在工程编译后的out目录下），添加dump配置，格式如下所示，参数说明参见[表1](#table32318383312)。
    ...
    **表 1**  acl.json文件格式说明
    ...
    <p id="p3929515181916"><a name="p3929515181916"></a><a name="p3929515181916"></a>通过ATC命令生成模型的json文件，在json文件中查找“"name"”字段对应值，查找模型名称和算子名称，模型名称在"graph"字段外、算子名称在"graph"字段内。生成json文件的方法请参考比对步骤中<a href="#li173468455137">2</a>的方法。</p>
    </td>
    </tr>
...
-   **[约束](#ZH-CN_TOPIC_0000002441982637)**  

-   **[比对数据说明](#ZH-CN_TOPIC_0000002441982645)**  

-   **[整网比对](#ZH-CN_TOPIC_0000002442022481)**  

-   **[单算子比对](#ZH-CN_TOPIC_0000002442022489)**  
...
-   **[命令格式说明](#ZH-CN_TOPIC_0000002408423358)**  

-   **[比对步骤](#ZH-CN_TOPIC_0000002441982633)**  
...
-   **[命令格式说明](#ZH-CN_TOPIC_0000002408583262)**  

-   **[比对步骤](#ZH-CN_TOPIC_0000002408423334)**  
...
-   **[如何进行dump数据文件Format转换](#ZH-CN_TOPIC_0000002442022469)**  

-   **[如何查看dump数据文件](#ZH-CN_TOPIC_0000002408423342)**  

-   **[安装依赖](#ZH-CN_TOPIC_0000002408583246)**  

## 如何进行dump数据文件Format转换<a name="ZH-CN_TOPIC_0000002442022469"></a>

-   **[执行Dump数据文件format转换](#ZH-CN_TOPIC_0000002441982653)**  

-   **[准备自定义Format转换.py文件](#ZH-CN_TOPIC_0000002408583254)**  
...
-   **[查看dump数据文件步骤](#ZH-CN_TOPIC_0000002408583242)**  
