...
-   **[入门学习](#ZH-CN_TOPIC_0000002408423562)**  

-   **[发布模式使用](#ZH-CN_TOPIC_0000002442022577)**  

-   **[调试模式使用](#ZH-CN_TOPIC_0000002442022605)**  

## 入门学习<a name="ZH-CN_TOPIC_0000002408423562"></a>

-   **[算子基本概念](#ZH-CN_TOPIC_0000002408423566)**  
...
-   **[获取ATC工具](#ZH-CN_TOPIC_0000002441982845)**  

-   **[获取custom样例工程](#ZH-CN_TOPIC_0000002442022697)**  

-   **[设置环境变量](#ZH-CN_TOPIC_0000002442022709)**  

-   **[编译custom样例工程](#ZH-CN_TOPIC_0000002441982757)**  

-   **[运行ATC](#ZH-CN_TOPIC_0000002408423442)**  
...
-   **[获取test样例工程](#ZH-CN_TOPIC_0000002442022657)**  

-   **[编译test样例工程](#ZH-CN_TOPIC_0000002408423590)**  

-   **[执行test样例工程](#ZH-CN_TOPIC_0000002408583386)**  
...
-   **[算子Op定义](#ZH-CN_TOPIC_0000002408423542)**  

## 算子Op定义<a name="ZH-CN_TOPIC_0000002408423542"></a>

-   **[原理](#ZH-CN_TOPIC_0000002441982749)**  

-   **[算子分析](#ZH-CN_TOPIC_0000002441982797)**  

-   **[工程创建](#ZH-CN_TOPIC_0000002441982813)**  

-   **[算子代码实现](#ZH-CN_TOPIC_0000002442022669)**  

-   **[算子工程编译部署](#ZH-CN_TOPIC_0000002442022689)**  
...
-   **[简介](#ZH-CN_TOPIC_0000002441982833)**  

-   **[算子工程编译](#ZH-CN_TOPIC_0000002441982825)**  
...
-   **[通用参数](#ZH-CN_TOPIC_0000002408583482)**  

-   **[通用接口](#ZH-CN_TOPIC_0000002408583354)**  

-   **[CPU推理参数](#ZH-CN_TOPIC_0000002408583426)**  

-   **[NNN参数及接口](#ZH-CN_TOPIC_0000002442022673)**  

## 通用参数<a name="ZH-CN_TOPIC_0000002408583482"></a>

-   **[ExtendedAttr类](#ZH-CN_TOPIC_0000002442022733)**  

-   **[AttributeType](#ZH-CN_TOPIC_0000002408583458)**  

-   **[AttributeType](#ZH-CN_TOPIC_0000002408583462)**  

-   **[Propagation推理参数](#ZH-CN_TOPIC_0000002408423518)**  

### ExtendedAttr类<a name="ZH-CN_TOPIC_0000002442022733"></a>

-   **[ExtendedAttr构造函数和析构函数](#ZH-CN_TOPIC_0000002408583390)**  

-   **[GetExtendedParam](#ZH-CN_TOPIC_0000002408423506)**  
...
-   **[ExtendedBuffer](#ZH-CN_TOPIC_0000002408423538)**  

-   **[ExtendedDataInfo](#ZH-CN_TOPIC_0000002408583450)**  

-   **[ExtendedDataInfoContainer](#ZH-CN_TOPIC_0000002442022613)**  

-   **[ExtendedForwardParam](#ZH-CN_TOPIC_0000002408423522)**  
...
-   **[ExtendedOpNodeBase类](#ZH-CN_TOPIC_0000002408423574)**  

-   **[ExtendedParserBase类](#ZH-CN_TOPIC_0000002441982869)**  

-   **[ExtendedPropagationBase类](#ZH-CN_TOPIC_0000002408423454)**  

-   **[UTILS API](#ZH-CN_TOPIC_0000002408423494)**  

### ExtendedOpNodeBase类<a name="ZH-CN_TOPIC_0000002408423574"></a>

-   **[ExtendedOpNodeBase构造函数和析构函数](#ZH-CN_TOPIC_0000002441982873)**  

-   **[Parser](#ZH-CN_TOPIC_0000002442022693)**  

-   **[CalcDataShape](#ZH-CN_TOPIC_0000002408423558)**  

-   **[CheckSpecification](#ZH-CN_TOPIC_0000002408583470)**  

-   **[SetIsAacpuOp](#ZH-CN_TOPIC_0000002408423514)**  

-   **[GetIsAAcpuOp](#ZH-CN_TOPIC_0000002408423462)**  

-   **[SetOpName](#ZH-CN_TOPIC_0000002408583346)**  

-   **[GetOpName](#ZH-CN_TOPIC_0000002408423546)**  
...
-   **[ExtendedParserBase构造函数和析构函数](#ZH-CN_TOPIC_0000002441982877)**  

-   **[ParseParam](#ZH-CN_TOPIC_0000002441982885)**  
...
-   **[ExtendedPropagationBase构造函数和析构函数](#ZH-CN_TOPIC_0000002408583410)**  

-   **[Forward](#ZH-CN_TOPIC_0000002442022665)**  

-   **[Init](#ZH-CN_TOPIC_0000002408423482)**  

-   **[Prepare](#ZH-CN_TOPIC_0000002442022629)**  

-   **[ForwardCpu](#ZH-CN_TOPIC_0000002408583446)**  

-   **[GetStride](#ZH-CN_TOPIC_0000002408423550)**  

-   **[GetactivateProp](#ZH-CN_TOPIC_0000002408423470)**  
...
-   **[CreateOpNode](#ZH-CN_TOPIC_0000002442022581)**  

-   **[GetLibVersion](#ZH-CN_TOPIC_0000002408583374)**  
...
-   **[ExtendedAAcpuBuffer](#ZH-CN_TOPIC_0000002408583438)**  

-   **[ExtendedAAcpuDataInfo](#ZH-CN_TOPIC_0000002408583466)**  

-   **[ExtendedAAcpuDataInfoContainer](#ZH-CN_TOPIC_0000002408583478)**  

-   **[ExtendedAAcpuForwardParam](#ZH-CN_TOPIC_0000002441982805)**  
...
-   **[数据结构定义](#ZH-CN_TOPIC_0000002441982781)**  

-   **[程序控制](#ZH-CN_TOPIC_0000002408583394)**  

-   **[接口定义](#ZH-CN_TOPIC_0000002408583398)**  

### 数据结构定义<a name="ZH-CN_TOPIC_0000002441982781"></a>

-   **[Scalar](#ZH-CN_TOPIC_0000002442022645)**  

-   **[Tensor](#ZH-CN_TOPIC_0000002441982745)**  

#### Scalar<a name="ZH-CN_TOPIC_0000002442022645"></a>

-   **[功能说明](#ZH-CN_TOPIC_0000002442022597)**  

-   **[数据类型定义](#ZH-CN_TOPIC_0000002441982769)**  

-   **[函数原型](#ZH-CN_TOPIC_0000002442022725)**  

-   **[约束](#ZH-CN_TOPIC_0000002442022681)**  

-   **[标量运算](#ZH-CN_TOPIC_0000002442022589)**  

-   **[调试接口](#ZH-CN_TOPIC_0000002408583382)**  

-   **[调用示例](#ZH-CN_TOPIC_0000002442022661)**  
...
-   **[功能说明](#ZH-CN_TOPIC_0000002408423502)**  

-   **[数据类型定义](#ZH-CN_TOPIC_0000002408583418)**  

-   **[函数原型](#ZH-CN_TOPIC_0000002441982753)**  

-   **[参数说明](#ZH-CN_TOPIC_0000002442022701)**  

-   **[支持操作](#ZH-CN_TOPIC_0000002408423490)**  

-   **[调试接口](#ZH-CN_TOPIC_0000002442022653)**  

-   **[调用示例](#ZH-CN_TOPIC_0000002442022601)**  
...
-   **[简介](#ZH-CN_TOPIC_0000002441982737)**  

-   **[if](#ZH-CN_TOPIC_0000002408583358)**  

-   **[while](#ZH-CN_TOPIC_0000002441982801)**  
...
-   **[if](#ZH-CN_TOPIC_0000002408583406)**  

-   **[if-else if](#ZH-CN_TOPIC_0000002408423582)**  

-   **[if-else](#ZH-CN_TOPIC_0000002408423530)**  

-   **[if-elseif-..-else](#ZH-CN_TOPIC_0000002442022593)**  
...
-   **[while](#ZH-CN_TOPIC_0000002408583434)**  

-   **[while-break](#ZH-CN_TOPIC_0000002442022621)**  
...
-   **[数据类型定义](#ZH-CN_TOPIC_0000002441982837)**  

-   **[离线数据接口](#ZH-CN_TOPIC_0000002408583362)**  

-   **[数据加载接口](#ZH-CN_TOPIC_0000002442022633)**  

-   **[数据存储接口](#ZH-CN_TOPIC_0000002441982765)**  

-   **[数据运算接口](#ZH-CN_TOPIC_0000002441982829)**  

-   **[利用率统计接口](#ZH-CN_TOPIC_0000002442022685)**  

-   **[DDR调试接口](#ZH-CN_TOPIC_0000002408583494)**  
...
-   **[GetOfflineParamAddr](#ZH-CN_TOPIC_0000002442022609)**  
...
-   **[Load](#ZH-CN_TOPIC_0000002408583350)**  
...
-   **[Store](#ZH-CN_TOPIC_0000002441982817)**  
...
-   **[VvAdd](#ZH-CN_TOPIC_0000002441982857)**  

-   **[VvSub](#ZH-CN_TOPIC_0000002408423498)**  

-   **[VvMul](#ZH-CN_TOPIC_0000002408423510)**  

-   **[VvDiv](#ZH-CN_TOPIC_0000002408583442)**  

-   **[VvMax](#ZH-CN_TOPIC_0000002408423486)**  

-   **[VvMin](#ZH-CN_TOPIC_0000002408583414)**  

-   **[VDivS](#ZH-CN_TOPIC_0000002408583366)**  

-   **[VSEmadS](#ZH-CN_TOPIC_0000002408423474)**  

-   **[VSEmadFaSb](#ZH-CN_TOPIC_0000002408583490)**  

-   **[VSEmadSaFb](#ZH-CN_TOPIC_0000002408423438)**  

-   **[VSigmoid](#ZH-CN_TOPIC_0000002441982841)**  

-   **[VTanh](#ZH-CN_TOPIC_0000002441982773)**  

-   **[VExp](#ZH-CN_TOPIC_0000002408583430)**  

-   **[Vlog](#ZH-CN_TOPIC_0000002408423450)**  

-   **[VSqrt](#ZH-CN_TOPIC_0000002442022641)**  

-   **[VDivF](#ZH-CN_TOPIC_0000002441982809)**  

-   **[VSEmadF](#ZH-CN_TOPIC_0000002408423458)**  

-   **[VSum](#ZH-CN_TOPIC_0000002442022617)**  

-   **[VMax](#ZH-CN_TOPIC_0000002441982861)**  

-   **[VMin](#ZH-CN_TOPIC_0000002408423578)**  

-   **[VVMad](#ZH-CN_TOPIC_0000002408583370)**  
...
-   **[InitSpace](#ZH-CN_TOPIC_0000002442022729)**  

-   **[GetSpaceSize](#ZH-CN_TOPIC_0000002408423586)**  

-   **[InitDataRandom](#ZH-CN_TOPIC_0000002441982821)**  

-   **[InitData](#ZH-CN_TOPIC_0000002441982853)**  

-   **[SetOfflineParamAddr](#ZH-CN_TOPIC_0000002408423446)**  

-   **[GetOfflineParamAddr](#ZH-CN_TOPIC_0000002408583402)**  

-   **[GetDdrSpace](#ZH-CN_TOPIC_0000002442022721)**  

-   **[SetDdrSpace](#ZH-CN_TOPIC_0000002408583454)**  

-   **[PrintSpace](#ZH-CN_TOPIC_0000002441982849)**  

-   **[PrintSpace](#ZH-CN_TOPIC_0000002441982761)**  
...
-   **[Cpu Sample介绍](#ZH-CN_TOPIC_0000002441982789)**  

-   **[NNN Sample介绍](#ZH-CN_TOPIC_0000002408583378)**  

## Cpu Sample介绍<a name="ZH-CN_TOPIC_0000002441982789"></a>

-   **[Prototxt定义](#ZH-CN_TOPIC_0000002441982793)**  

-   **[Custom工程开发](#ZH-CN_TOPIC_0000002442022625)**  

-   **[仿真工程运行结果](#ZH-CN_TOPIC_0000002442022585)**  
...
-   **[AbsOpNode](#ZH-CN_TOPIC_0000002408583486)**  

-   **[AbsParser](#ZH-CN_TOPIC_0000002408423466)**  

-   **[Propagation](#ZH-CN_TOPIC_0000002442022717)**  

-   **[AbsCpuForward](#ZH-CN_TOPIC_0000002441982865)**  
...
-   **[仿真工程测试](#ZH-CN_TOPIC_0000002408583422)**  

-   **[板端工程测试](#ZH-CN_TOPIC_0000002441982889)**  
...
-   **[Prototxt定义](#ZH-CN_TOPIC_0000002408583474)**  

-   **[Custom工程开发](#ZH-CN_TOPIC_0000002441982741)**  

-   **[仿真工程运行结果](#ZH-CN_TOPIC_0000002442022637)**  
...
-   **[AddOpNode](#ZH-CN_TOPIC_0000002408423554)**  

-   **[AddParser](#ZH-CN_TOPIC_0000002441982881)**  

-   **[Propagation](#ZH-CN_TOPIC_0000002408423534)**  

-   **[AddProcessLayer](#ZH-CN_TOPIC_0000002441982777)**  
...
-   **[仿真测试工程测试](#ZH-CN_TOPIC_0000002442022649)**  

-   **[板端工程运行测试](#ZH-CN_TOPIC_0000002408583498)**  
