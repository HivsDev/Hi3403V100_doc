...
-   **[简介](#ZH-CN_TOPIC_0000002408423214)**  

-   **[概念介绍](#ZH-CN_TOPIC_0000002408583046)**  

-   **[运行流程](#ZH-CN_TOPIC_0000002441982513)**  
...
-   **[训练后量化](#ZH-CN_TOPIC_0000002441982497)**  

-   **[量化感知训练](#ZH-CN_TOPIC_0000002408423234)**  

### 训练后量化<a name="ZH-CN_TOPIC_0000002441982497"></a>

训练后量化，是指将训练后模型中的权重由float32量化到int8或者int4，并通过少量校准数据集在模型推理时对数据（activation）进行校准量化。量化过程请参见[训练后量化](#ZH-CN_TOPIC_0000002442022273)。
...
量化感知训练缺点是较为耗时，同时需要大量数据。量化过程请参见[量化感知训练](#ZH-CN_TOPIC_0000002442022353)。
...
量化训练，支持量化的层以及约束参见[表1](#table146mcpsimp)。
...
-   **[安装AMCT](#ZH-CN_TOPIC_0000002441982537)**  

-   **[更新AMCT](#ZH-CN_TOPIC_0000002441982453)**  

-   **[卸载AMCT](#ZH-CN_TOPIC_0000002442022281)**  

## 安装AMCT<a name="ZH-CN_TOPIC_0000002441982537"></a>

-   **[获取软件包](#ZH-CN_TOPIC_0000002442022305)**  

-   **[安装前准备](#ZH-CN_TOPIC_0000002408423134)**  

-   **[安装](#ZH-CN_TOPIC_0000002408423186)**  

-   **[日志级别控制](#ZH-CN_TOPIC_0000002408583110)**  
...
-   **[Ubuntu x86系统](#ZH-CN_TOPIC_0000002408423150)**  

#### Ubuntu x86系统<a name="ZH-CN_TOPIC_0000002408423150"></a>

-   **[AMCT用户准备（可选）](#ZH-CN_TOPIC_0000002441982481)**  

-   **[配置AMCT安装用户权限（可选）](#ZH-CN_TOPIC_0000002441982477)**  

-   **[环境准备](#ZH-CN_TOPIC_0000002408423226)**  

-   **[检查源](#ZH-CN_TOPIC_0000002442022369)**  

-   **[安装依赖](#ZH-CN_TOPIC_0000002442022337)**  

-   **[上传软件包](#ZH-CN_TOPIC_0000002442022285)**  
...
<td class="cellrowborder" valign="top" width="9.31%" headers="mcps1.2.4.1.2 "><p id="p361615142117"><a name="p361615142117"></a><a name="p361615142117"></a>-</p>
</td>
...
-   **[训练后量化](#ZH-CN_TOPIC_0000002442022273)**  

-   **[量化感知训练](#ZH-CN_TOPIC_0000002442022353)**  

-   **[量化算法](#ZH-CN_TOPIC_0000002441982461)**  

-   **[工具实现的融合功能](#ZH-CN_TOPIC_0000002408583106)**  

## 训练后量化<a name="ZH-CN_TOPIC_0000002442022273"></a>

-   **[实现原理](#ZH-CN_TOPIC_0000002442022365)**  

-   **[量化示例](#ZH-CN_TOPIC_0000002408423198)**  

-   **[量化调优](#ZH-CN_TOPIC_0000002441982525)**  
...
-   **[量化前提](#ZH-CN_TOPIC_0000002408583154)**  

-   **[量化步骤](#ZH-CN_TOPIC_0000002442022349)**  

#### 量化前提<a name="ZH-CN_TOPIC_0000002408583154"></a>

-   **[模型准备](#ZH-CN_TOPIC_0000002408583126)**  

-   **[数据集准备](#ZH-CN_TOPIC_0000002442022317)**  

-   **[校准集准备](#ZH-CN_TOPIC_0000002408583094)**  
...
3.  量化结果说明。
    ...
    -   tmp/calibration：临时文件
        -   config.json：描述了如何对模型中的每一层进行量化。如果量化脚本所在目录下已经存在量化配置文件，则再次调用[create\_quant\_config\_fx](#ZH-CN_TOPIC_0000002441982485)接口时，如果新生成的量化配置文件与已有的文件同名，则会覆盖已有的量化配置文件，否则生成新的量化配置文件。
            ...
            如果量化后的模型推理精度不满足要求，用户可以修改config.json文件，量化配置文件内容、修改原则以及参数解释请参见[量化调优](#ZH-CN_TOPIC_0000002441982525)。
...
-   **[参数配置说明](#ZH-CN_TOPIC_0000002408583150)**  

-   **[参数调优说明](#ZH-CN_TOPIC_0000002408583070)**  
...
-   **[实现原理](#ZH-CN_TOPIC_0000002441982529)**  

-   **[量化示例](#ZH-CN_TOPIC_0000002442022313)**  

-   **[量化调优](#ZH-CN_TOPIC_0000002441982493)**  
...
-   **[量化前提](#ZH-CN_TOPIC_0000002408583078)**  

-   **[量化步骤](#ZH-CN_TOPIC_0000002408423170)**  
...
-   **[参数配置说明](#ZH-CN_TOPIC_0000002441982533)**  

-   **[参数调优说明](#ZH-CN_TOPIC_0000002441982465)**  
...
配置文件中参数说明参照[参数配置说明](#ZH-CN_TOPIC_0000002408583150)。
...
-   **[observer算法](#ZH-CN_TOPIC_0000002442022321)**  

-   **[fakequant算法](#ZH-CN_TOPIC_0000002408423142)**  

-   **[自定义量化算法](#ZH-CN_TOPIC_0000002408583058)**  

### observer算法<a name="ZH-CN_TOPIC_0000002442022321"></a>

-   **[IFMRObserver](#ZH-CN_TOPIC_0000002442022309)**  

-   **[ArqObserver](#ZH-CN_TOPIC_0000002441982469)**  

-   **[LuqMseObserver](#ZH-CN_TOPIC_0000002408423230)**  

-   **[SnqObserver](#ZH-CN_TOPIC_0000002441982489)**  
...
-   **[ARQ权重量化算法](#ZH-CN_TOPIC_0000002441982509)**  

-   **[ULQ数据量化算法](#ZH-CN_TOPIC_0000002408583122)**  

-   **[LUQ量化算法](#ZH-CN_TOPIC_0000002442022357)**  

-   **[LNQ权重量化算法](#ZH-CN_TOPIC_0000002441982449)**  

-   **[Fixed量化算法](#ZH-CN_TOPIC_0000002408423174)**  
...
-   **[简介](#ZH-CN_TOPIC_0000002530273011)**  

-   **[amct.nn.modules](#ZH-CN_TOPIC_0000002530113047)**  
...
-   **[create\_quant\_config\_fx](#ZH-CN_TOPIC_0000002441982485)**  

-   **[create\_quant\_model\_fx](#ZH-CN_TOPIC_0000002442022289)**  

-   **[save\_quant\_model\_fx](#ZH-CN_TOPIC_0000002408583062)**  

-   **[enable\_quantization](#ZH-CN_TOPIC_0000002441982521)**  

-   **[enable\_dump](#ZH-CN_TOPIC_0000002441982505)**  

-   **[restore\_quant\_model\_fx](#ZH-CN_TOPIC_0000002441982501)**  
...
-   **[不支持torch的自动混精模式](#ZH-CN_TOPIC_0000002408583142)**  

-   **[不支持动态控制流](#ZH-CN_TOPIC_0000002408583102)**  
...
-   **[接口说明](#ZH-CN_TOPIC_0000002408423202)**  

-   **[动态图版本FAQ](#ZH-CN_TOPIC_0000002408583114)**  

-   **[拓展单输入单输出module量化](#ZH-CN_TOPIC_0000002442022329)**  

-   **[动态图附录](#ZH-CN_TOPIC_0000002408583074)**  

## 接口说明<a name="ZH-CN_TOPIC_0000002408423202"></a>

-   **[训练后量化](#ZH-CN_TOPIC_0000002408583082)**  

-   **[量化感知训练](#ZH-CN_TOPIC_0000002408423162)**  

### 训练后量化<a name="ZH-CN_TOPIC_0000002408583082"></a>

-   **[create\_quant\_config](#ZH-CN_TOPIC_0000002442022345)**  

-   **[quantize\_model](#ZH-CN_TOPIC_0000002408423206)**  

-   **[save\_model](#ZH-CN_TOPIC_0000002408423154)**  

-   **[update\_bn\_status](#ZH-CN_TOPIC_0000002408583086)**  
...
-   **[create\_quant\_retrain\_config](#ZH-CN_TOPIC_0000002441982441)**  

-   **[create\_quant\_retrain\_model](#ZH-CN_TOPIC_0000002408583146)**  

-   **[restore\_quant\_retrain\_model](#ZH-CN_TOPIC_0000002442022293)**  

-   **[save\_quant\_retrain\_model](#ZH-CN_TOPIC_0000002442022341)**  
...
-   **[AMCT Pytorch量化约束说明](#ZH-CN_TOPIC_0000002442022297)**  

-   **[如何适配拓展层](#ZH-CN_TOPIC_0000002442022277)**  

-   **[retrain场景，重复使用的层需多次定义](#ZH-CN_TOPIC_0000002408423210)**  

-   **[chunk算子替换成split算子](#ZH-CN_TOPIC_0000002408583098)**  
...
-   **[训练后量化简易配置文件说明](#ZH-CN_TOPIC_0000002408583118)**  

-   **[量化感知训练简易配置文件说明](#ZH-CN_TOPIC_0000002441982457)**  
...
-   **[fx.symbolic\_trace异常场景汇总](#ZH-CN_TOPIC_0000002498513066)**  

-   **[如何跳过整个模块量化\(如后处理\)](#ZH-CN_TOPIC_0000002498513072)**  

-   **[静态图模型如何定位bug](#ZH-CN_TOPIC_0000002530273019)**  

-   **[forward方法中包含动态获取的参数](#ZH-CN_TOPIC_0000002530113055)**  

-   **[pip install 安装torch包失败](#ZH-CN_TOPIC_0000002498353092)**  

-   **[onnx算子拆分场景说明](#ZH-CN_TOPIC_0000002498513074)**  

-   **[安装python3-tk时提示错误信息](#ZH-CN_TOPIC_0000002530273021)**  

-   **[不支持输入大于两维且bias为True的linear量化](#ZH-CN_TOPIC_0000002530113057)**  

-   **[离线计算卷积量化后转om报错](#ZH-CN_TOPIC_0000002498353094)**  

-   **[避免在pytorch模型脚本中引入无效的操作导致掉点](#ZH-CN_TOPIC_0000002498513076)**  

-   **[兄弟节点量化系数不一致导致atc报错](#ZH-CN_TOPIC_0000002530273023)**  

-   **[找不到dot文件](#ZH-CN_TOPIC_0000002530113061)**  

-   **[ModuleNotFoundError: No module named 'wheel' or No module named 'torch'](#ZH-CN_TOPIC_0000002498353096)**  

-   **[libcudart.so.\*: cannot open shared object file: No such file or directory](#ZH-CN_TOPIC_0000002498513080)**  

-   **[mamtul第二路值域较宽导致掉点问题](#ZH-CN_TOPIC_0000002530273025)**  
...
-   **[torch.fx不支持动态控制流](#ZH-CN_TOPIC_0000002530273013)**  

-   **[Tracer使用类自定义跟踪](#ZH-CN_TOPIC_0000002530113049)**  

-   **[非torch函数不可追踪](#ZH-CN_TOPIC_0000002498353086)**  

-   **[张量构造函数不可追踪](#ZH-CN_TOPIC_0000002498513068)**  

-   **[tensor.dtype类型转换函数不可追踪](#ZH-CN_TOPIC_0000002530273015)**  

-   **[assert函数不可追踪](#ZH-CN_TOPIC_0000002530113051)**  

-   **[数据按下标或切片赋值操作不可追踪](#ZH-CN_TOPIC_0000002498353088)**  

-   **[proxy对象不可迭代](#ZH-CN_TOPIC_0000002498513070)**  

-   **[fx模型中的变量类型无法判断](#ZH-CN_TOPIC_0000002530273017)**  

-   **[静态控制流变量](#ZH-CN_TOPIC_0000002530113053)**  

-   **[proxy对象无法被deepcopy](#ZH-CN_TOPIC_0000002498353090)**  
...
-   **[支持量化的算子列表](#ZH-CN_TOPIC_0000002498353100)**  

-   **[静态图简易量化配置功能说明](#ZH-CN_TOPIC_0000002498513082)**  

-   **[cube only 量化](#ZH-CN_TOPIC_0000002530273027)**  

-   **[误差分析功能的使用介绍](#ZH-CN_TOPIC_0000002530113065)**  

-   **[量化因子记录文件说明](#ZH-CN_TOPIC_0000002498353102)**  

-   **[安装Python3.7.5（Ubuntu）](#ZH-CN_TOPIC_0000002530113067)**  

-   **[dot图可视化](#ZH-CN_TOPIC_0000002498353104)**  
...
<td class="cellrowborder" valign="top" headers="mcps1.2.5.1.3 "><p id="p94798438309"><a name="p94798438309"></a><a name="p94798438309"></a>-</p>
</td>
</tr>
...
-   **[量化因子记录文件格式说明](#ZH-CN_TOPIC_0000002498513084)**  

-   **[量化因子说明](#ZH-CN_TOPIC_0000002530273029)**  
