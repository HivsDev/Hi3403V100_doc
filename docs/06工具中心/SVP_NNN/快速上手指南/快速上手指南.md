...
-   **[功能框架](#ZH-CN_TOPIC_0000002446642273)**  

-   **[工具功能](#ZH-CN_TOPIC_0000002413203024)**  
...
-   **[开发环境](#ZH-CN_TOPIC_0000002446642261)**  

-   **[命令行开发环境安装](#ZH-CN_TOPIC_0000002413043196)**  

## 开发环境<a name="ZH-CN_TOPIC_0000002446642261"></a>

该场景下的开发环境需要单独部署SVP\__NNN_\_PC软件包，采用命令行的方式进行安装和使用。

-   **[简介](#ZH-CN_TOPIC_0000002446642257)**  

-   **[使用流程](#ZH-CN_TOPIC_0000002413043208)**  
...
-   **[软件包获取](#ZH-CN_TOPIC_0000002446762145)**  

-   **[环境要求](#ZH-CN_TOPIC_0000002446642269)**  

-   **[软件包安装](#ZH-CN_TOPIC_0000002413203020)**  

-   **[安装后处理](#ZH-CN_TOPIC_0000002446642265)**  
...
-   **[SVP ACL Sample简介](#ZH-CN_TOPIC_0000002413203028)**  

-   **[模型编译](#ZH-CN_TOPIC_0000002446642313)**  

-   **[模型部署运行](#ZH-CN_TOPIC_0000002446642297)**  

## SVP ACL Sample简介<a name="ZH-CN_TOPIC_0000002413203028"></a>

-   **[PC Sample](#ZH-CN_TOPIC_0000002446762165)**  

-   **[开发板Sample](#ZH-CN_TOPIC_0000002446762177)**  

-   **[ACL接口介绍](#ZH-CN_TOPIC_0000002446762157)**  
...
-   **[模型编译](#ZH-CN_TOPIC_0000002446642305)**  
...
-   **[运行前准备](#ZH-CN_TOPIC_0000002446762173)**  

-   **[命令说明](#ZH-CN_TOPIC_0000002413043232)**  

-   **[模型编译](#ZH-CN_TOPIC_0000002446642301)**  
...
-   **[编译示例](#ZH-CN_TOPIC_0000002446642293)**  

-   **[运行示例](#ZH-CN_TOPIC_0000002413203064)**  

### 编译示例<a name="ZH-CN_TOPIC_0000002446642293"></a>

-   **[环境准备](#ZH-CN_TOPIC_0000002413043236)**  

-   **[本地编译](#ZH-CN_TOPIC_0000002413043228)**  
...
-   **[数据准备](#ZH-CN_TOPIC_0000002446762161)**  

-   **[仿真运行](#ZH-CN_TOPIC_0000002413203068)**  

-   **[开发板运行](#ZH-CN_TOPIC_0000002413203056)**  

-   **[运行后处理](#ZH-CN_TOPIC_0000002413203052)**  
...
-   **[环境安装](#ZH-CN_TOPIC_0000002413203060)**  

-   **[运行准备](#ZH-CN_TOPIC_0000002413043220)**  

-   **[运行](#ZH-CN_TOPIC_0000002446762181)**  
...
-   **[MindCmd工具准备](#ZH-CN_TOPIC_0000002413043240)**  

-   **[资源准备](#ZH-CN_TOPIC_0000002413203072)**  

-   **[仿真运行](#ZH-CN_TOPIC_0000002446642289)**  

-   **[开发板运行](#ZH-CN_TOPIC_0000002446762169)**  
...
请参考《SSxxxVxxx SDK 安装以及升级使用说明》完成板端基础环境安装。参考《驱动和开发环境安装指南》“OpenSSH服务搭建”章节完成板端ssh环境安装，[服务器NFS环境安装](#li421mcpsimp)。
...
-   **[精度分析](#ZH-CN_TOPIC_0000002446642285)**  

-   **[性能分析](#ZH-CN_TOPIC_0000002413043244)**  

## 精度分析<a name="ZH-CN_TOPIC_0000002446642285"></a>

本章节主要介绍常见精度问题的定位和分析。精度问题也叫精度掉点，是指在相同的输入下，离线模型的推理结果和原始模型的推理结果偏差超出业务可接受范围。

-   **[常见的精度问题来源](#ZH-CN_TOPIC_0000002413043216)**  

-   **[界定精度问题的引入阶段](#ZH-CN_TOPIC_0000002413203044)**  

-   **[使用MindCmd一键推理进行精度比对](#ZH-CN_TOPIC_0000002446642309)**  

-   **[精度调优建议](#ZH-CN_TOPIC_0000002413203048)**  
...
-   **[获取性能数据](#ZH-CN_TOPIC_0000002446642281)**  

-   **[性能问题分析及性能调优](#ZH-CN_TOPIC_0000002413043200)**  

### 获取性能数据<a name="ZH-CN_TOPIC_0000002446642281"></a>

获取性能数据有以下两种方式。

-   **[通过调用ACL API方式采集Profiling数据](#ZH-CN_TOPIC_0000002446642277)**  

-   **[使用MindCmd工具获取性能数据](#ZH-CN_TOPIC_0000002446762133)**  
...
-   **[自定义算子](#ZH-CN_TOPIC_0000002413203040)**  

-   **[IR构图](#ZH-CN_TOPIC_0000002446762153)**  
...
-   **[参考文档](#ZH-CN_TOPIC_0000002446762137)**  
