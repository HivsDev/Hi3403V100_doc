...
-   **[Ascend NNN简介](#ZH-CN_TOPIC_0000002441980573)**  

-   **[部署架构](#ZH-CN_TOPIC_0000002442020509)**  

-   **[使用流程](#ZH-CN_TOPIC_0000002408581302)**  
...
-   **[板端环境安装](#ZH-CN_TOPIC_0000002441980625)**  

-   **[命令行方式开发环境安装](#ZH-CN_TOPIC_0000002442020497)**  
...
-   **[简介](#ZH-CN_TOPIC_0000002442020413)**  

-   **[软件包获取](#ZH-CN_TOPIC_0000002408581210)**  

-   **[安装前准备](#ZH-CN_TOPIC_0000002408581286)**  

-   **[软件包安装](#ZH-CN_TOPIC_0000002408421290)**  

-   **[安装后处理](#ZH-CN_TOPIC_0000002442020441)**  

-   **[常用操作](#ZH-CN_TOPIC_0000002408421394)**  

-   **[附录](#ZH-CN_TOPIC_0000002408421338)**  
...
-   **[查询软件包版本号](#ZH-CN_TOPIC_0000002442020525)**  

-   **[升级软件包](#ZH-CN_TOPIC_0000002408581318)**  

-   **[解压软件包](#ZH-CN_TOPIC_0000002408421298)**  

-   **[卸载软件包](#ZH-CN_TOPIC_0000002441980589)**  

-   **[设置用户有效期](#ZH-CN_TOPIC_0000002408581206)**  

-   **[配置pip源](#ZH-CN_TOPIC_0000002442020429)**  
...
-   **[参数说明/常用命令](#ZH-CN_TOPIC_0000002442020425)**  
...
-   **[板端Linux环境OpenSSH服务搭建](#ZH-CN_TOPIC_0000002441980669)**  

## 板端Linux环境OpenSSH服务搭建<a name="ZH-CN_TOPIC_0000002441980669"></a>

-   **[交叉编译](#ZH-CN_TOPIC_0000002441980617)**  

-   **[部署](#ZH-CN_TOPIC_0000002442020473)**  

### 交叉编译<a name="ZH-CN_TOPIC_0000002441980617"></a>

-   **[依赖软件包准备](#ZH-CN_TOPIC_0000002408581278)**  

-   **[交叉编译环境准备](#ZH-CN_TOPIC_0000002441980569)**  

-   **[交叉编译](#ZH-CN_TOPIC_0000002408581234)**  
...
-   **[zlib](#ZH-CN_TOPIC_0000002441980653)**  

-   **[OpenSSL](#ZH-CN_TOPIC_0000002441980641)**  

-   **[OpenSSH](#ZH-CN_TOPIC_0000002441980685)**  
...
-   **[挂载命令](#ZH-CN_TOPIC_0000002441980601)**  

-   **[首次部署操作](#ZH-CN_TOPIC_0000002408421322)**  

-   **[快速部署操作](#ZH-CN_TOPIC_0000002408421370)**  
...
完成[交叉编译](#ZH-CN_TOPIC_0000002441980617)和[首次部署操作](#ZH-CN_TOPIC_0000002408421322)操作后，下次启动sshd，可参考如下快速启动。
...
-   **[宿主机与容器操作系统兼容性关系](#ZH-CN_TOPIC_0000002408421310)**  

-   **[前提条件](#ZH-CN_TOPIC_0000002408421382)**  

-   **[操作步骤](#ZH-CN_TOPIC_0000002408581222)**  

-   **[编写示例](#ZH-CN_TOPIC_0000002408581262)**  

-   **[部署容器](#ZH-CN_TOPIC_0000002408581250)**  
...
2.  创建软件包上传路径，在Dockerfile文件同级目录下新建Resources目录。
    ...
    以“/home/$USER”为例，若/home/$USER下存放构建镜像所需的Dockerfile，则需在该路径下新建一个Resources文件夹存放项目所需软件包及相关文件（如  [表1](#table15806292115)所示）。

    ```
    mkdir -p /home/$USER/Resources
    ```

3.  将[表1](#table15806292115)所示软件包及相关文件上传至服务器“/home/$USER/Resources”目录下。
...
4.  准备Dockerfile上传至服务器“/home/$USER”\(即软件包文件夹Resources的同级目录下\)。
    ...
    >-   请检查Resources目录下是否仅存放[表1](#table15806292115)中所提及的文件及软件包，引入其他文件或软件包可能导致镜像构建失败。
...
>    步骤3的操作，用户也可使用Xserver新建ssh连接，ip填写docker宿主机的ip，端口选择[运行容器时](#li672910821419)配置的端口号。（可选）
