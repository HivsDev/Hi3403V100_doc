...
-   **[功能框架图](#ZH-CN_TOPIC_0000002442020637)**  

-   **[工具功能](#ZH-CN_TOPIC_0000002442020581)**  
...
-   **[软件包获取](#ZH-CN_TOPIC_0000002442020661)**  

-   **[安装前准备](#ZH-CN_TOPIC_0000002441980749)**  

-   **[安装MindCmd](#ZH-CN_TOPIC_0000002408581230)**  

-   **[全局配置](#ZH-CN_TOPIC_0000002442020665)**  
...
-   **[Ubuntu18.04-x86\_64系统](#ZH-CN_TOPIC_0000002441980633)**  
...
-   **[功能介绍](#ZH-CN_TOPIC_0000002441980765)**  

-   **[Caffe模型一键推理](#ZH-CN_TOPIC_0000002408421546)**  

-   **[PyTorch模型一键推理](#ZH-CN_TOPIC_0000002408581310)**  

-   **[ONNX模型一键推理](#ZH-CN_TOPIC_0000002441980689)**  

-   **[Deployed模型一键推理](#ZH-CN_TOPIC_0000002408421374)**  
...
-   **[命令行格式说明](#ZH-CN_TOPIC_0000002442020649)**  

-   **[执行样例](#ZH-CN_TOPIC_0000002442020417)**  
...
<p id="p129mcpsimp"><a name="p129mcpsimp"></a><a name="p129mcpsimp"></a>如果开启了<a href="#p181443912363">上板推理开关</a>（IS_<em id="i1696934423315"><a name="i1696934423315"></a><a name="i1696934423315"></a>NNN</em>_RUN=1），则工作目录不能超出<a href="#ZH-CN_TOPIC_0000002408421542">ssh.cfg文件配置</a>小节中“HOST_MOUNT_PATH”配置的路径。</p>
</td>
</tr>
...
-   **[命令行格式说明](#ZH-CN_TOPIC_0000002442020573)**  

-   **[执行样例](#ZH-CN_TOPIC_0000002408421518)**  

-   **[量化后模型一键推理](#ZH-CN_TOPIC_0000002408581354)**  

-   **[硬件感知一键推理](#ZH-CN_TOPIC_0000002408421494)**  
...
<p id="p129mcpsimp"><a name="p129mcpsimp"></a><a name="p129mcpsimp"></a>如果开启了<a href="#p181443912363">上板推理开关</a>（IS_<em id="i1042152314349"><a name="i1042152314349"></a><a name="i1042152314349"></a>NNN</em>_RUN=1），则工作目录不能超出<a href="#ZH-CN_TOPIC_0000002408421542">ssh.cfg文件配置</a>小节中HOST_MOUNT_PATH配置的路径。</p>
</td>
</tr>
...
-   **[命令行格式说明](#ZH-CN_TOPIC_0000002408421390)**  

-   **[执行样例](#ZH-CN_TOPIC_0000002408421422)**  
...
<p id="p129mcpsimp"><a name="p129mcpsimp"></a><a name="p129mcpsimp"></a>如果开启了<a href="#p181443912363">上板推理开关</a>（IS_<em id="i142475143517"><a name="i142475143517"></a><a name="i142475143517"></a>NNN</em>_RUN=1），则工作目录不能超出<a href="#ZH-CN_TOPIC_0000002408421542">ssh.cfg文件配置</a>小节中HOST_MOUNT_PATH配置的路径。</p>
</td>
</tr>
...
-   **[功能介绍](#ZH-CN_TOPIC_0000002408581246)**  

-   **[命令行格式说明](#ZH-CN_TOPIC_0000002442020609)**  

-   **[执行样例](#ZH-CN_TOPIC_0000002441980733)**  
...
-   **[功能介绍](#ZH-CN_TOPIC_0000002442020569)**  

-   **[Caffe模型推理](#ZH-CN_TOPIC_0000002442020553)**  

-   **[ONNX模型推理](#ZH-CN_TOPIC_0000002408421342)**  
...
-   **[命令行格式说明](#ZH-CN_TOPIC_0000002441980793)**  

-   **[执行样例](#ZH-CN_TOPIC_0000002408581334)**  
...
-   **[命令行格式说明](#ZH-CN_TOPIC_0000002442020437)**  

-   **[执行样例](#ZH-CN_TOPIC_0000002441980741)**  
...
-   **[功能介绍](#ZH-CN_TOPIC_0000002441980649)**  

-   **[Caffe模型压缩](#ZH-CN_TOPIC_0000002441980713)**  

-   **[PyTorch模型压缩](#ZH-CN_TOPIC_0000002442020617)**  
...
-   **[命令行格式说明](#ZH-CN_TOPIC_0000002408421462)**  

-   **[执行样例](#ZH-CN_TOPIC_0000002441980597)**  
...
-   **[命令行格式说明](#ZH-CN_TOPIC_0000002442020601)**  

-   **[执行样例](#ZH-CN_TOPIC_0000002408421326)**  
...
-   **[功能介绍](#ZH-CN_TOPIC_0000002441980801)**  

-   **[命令行格式说明](#ZH-CN_TOPIC_0000002408421478)**  

-   **[执行样例](#ZH-CN_TOPIC_0000002441980673)**  
...
-   **[功能介绍](#ZH-CN_TOPIC_0000002408421522)**  

-   **[功能仿真](#ZH-CN_TOPIC_0000002408421434)**  

-   **[指令仿真](#ZH-CN_TOPIC_0000002442020485)**  

-   **[上板推理](#ZH-CN_TOPIC_0000002408581374)**  
...
-   **[命令行格式说明](#ZH-CN_TOPIC_0000002408421314)**  

-   **[执行样例](#ZH-CN_TOPIC_0000002408421358)**  
...
<td class="cellrowborder" valign="top" width="71.39999999999999%" headers="mcps1.2.4.1.3 "><p id="p735mcpsimp"><a name="p735mcpsimp"></a><a name="p735mcpsimp"></a>指定工作路径，否则使用<a href="#table73353166121">表1</a>中配置的默认工作路径。</p>
</td>
</tr>
...
-   **[命令行格式说明](#ZH-CN_TOPIC_0000002441980825)**  

-   **[执行样例](#ZH-CN_TOPIC_0000002408581282)**  
...
<td class="cellrowborder" valign="top" width="70.28%" headers="mcps1.2.4.1.3 "><p id="p173092417238"><a name="p173092417238"></a><a name="p173092417238"></a>指定工作路径，否则使用<a href="#table73353166121">表1</a>中配置的默认工作路径。</p>
</td>
</tr>
...
-   **[命令行格式说明](#ZH-CN_TOPIC_0000002408581426)**  

-   **[执行样例](#ZH-CN_TOPIC_0000002441980757)**  
...
<td class="cellrowborder" valign="top" width="70.28%" headers="mcps1.2.4.1.3 "><p id="p589394112315"><a name="p589394112315"></a><a name="p589394112315"></a>指定工作路径，否则使用<a href="#table73353166121">表1</a>中配置的默认工作路径。<strong id="b188931541112314"><a name="b188931541112314"></a><a name="b188931541112314"></a>上板推理要求工作路径必须在HOST_MOUNT_PATH下</strong>。</p>
</td>
</tr>
...
-   准备ssh.cfg文件，参考[ssh.cfg文件配置](#ZH-CN_TOPIC_0000002408421542)

    ssh.cfg文件配置优先级如下：-s/--ssh\_config参数配置 \> mindcmd.ini中的全局配置（[SSH\_CFG\_PATH](#p687126112118)）。
...
-   **[功能介绍](#ZH-CN_TOPIC_0000002442020529)**  

-   **[命令行格式说明](#ZH-CN_TOPIC_0000002442020589)**  

-   **[执行样例](#ZH-CN_TOPIC_0000002441980613)**  
...
-   **[功能介绍](#ZH-CN_TOPIC_0000002442020561)**  

-   **[命令行格式说明](#ZH-CN_TOPIC_0000002408581394)**  

-   **[执行样例](#ZH-CN_TOPIC_0000002408581450)**  
...
-   **[Caffe模型子网导出](#ZH-CN_TOPIC_0000002441980809)**  

-   **[cmd命令转换为cfg文件](#ZH-CN_TOPIC_0000002442020629)**  

-   **[文件格式转换](#ZH-CN_TOPIC_0000002408421294)**  

-   **[UnInplace](#ZH-CN_TOPIC_0000002408581346)**  

## Caffe模型子网导出<a name="ZH-CN_TOPIC_0000002441980809"></a>

该功能用于原始Caffe网络的剪切。

-   **[命令行格式说明](#ZH-CN_TOPIC_0000002441980661)**  

-   **[执行样例](#ZH-CN_TOPIC_0000002408581266)**  
...
-   **[命令行格式说明](#ZH-CN_TOPIC_0000002408581458)**  

-   **[执行样例](#ZH-CN_TOPIC_0000002442020645)**  
...
-   **[命令行格式说明](#ZH-CN_TOPIC_0000002408581366)**  

-   **[执行样例](#ZH-CN_TOPIC_0000002442020657)**  
...
-   **[命令行格式说明](#ZH-CN_TOPIC_0000002441980701)**  

-   **[执行样例](#ZH-CN_TOPIC_0000002408581294)**  
...
-   **[MindCmd子命令](#ZH-CN_TOPIC_0000002408581406)**  

-   **[NFS环境搭建](#ZH-CN_TOPIC_0000002441980773)**  

-   **[ssh.cfg文件配置](#ZH-CN_TOPIC_0000002408421542)**  

-   **[数据预处理配置文件样例](#ZH-CN_TOPIC_0000002408421442)**  

-   **[Docker容器中使用MindCmd](#ZH-CN_TOPIC_0000002408581214)**  

-   **[安装Python3.7.5（Ubuntu）](#ZH-CN_TOPIC_0000002408421450)**  

-   **[公网URL](#ZH-CN_TOPIC_0000002408581362)**  

-   **[使用alias别名简化输入命令](#ZH-CN_TOPIC_0000002441980721)**  

-   **[FAQ](#ZH-CN_TOPIC_0000002442020469)**  
...
ssh.cfg配置文件路径可写入MindCmd全局配置文件的[SSH\_CFG\_PATH](#p687126112118)配置项，或作为工具命令行参数--ssh\_config的值。

>![](public_sys-resources/icon-note.gif) **说明：** 
>-   MindCmd工具上板推理时会根据以上配置文件提供的信息，自动执行mount、umount操作。
>-   HOST\_MOUNT\_PATH配置的路径不能超出[2](#li540246153120)所配置的NFS共享目录范围，否则可能会导致mount失败。
...
3.  安装python3.7.5。
    ...
    -   如果python安装用户为非root：
        ...
        该场景下模型压缩工具使用非root用户进行安装，请以非root用户在任意目录下执行**vi \~/.bashrc**命令，打开.bashrc文件，在文件最后一行后面添加如下内容。
...
-   **[挂载命令中的ip与服务器ip不符](#ZH-CN_TOPIC_0000002442020501)**  

-   **[找不到mindcmd命令](#ZH-CN_TOPIC_0000002442020449)**  

-   **[关于工作路径、挂载路径、数据卷路径和NFS共享路径](#ZH-CN_TOPIC_0000002408421510)**  

-   **[MindCmd安装失败，找不到Rust编译器](#ZH-CN_TOPIC_0000002408581462)**  

-   **[PyTorch模型推理失败](#ZH-CN_TOPIC_0000002408421502)**  

-   **[Pytorch模型推理报错](#ZH-CN_TOPIC_0000002408421410)**  
