...
-   **[工具概述](#ZH-CN_TOPIC_0000002408169708)**  

-   **[工具界面概述](#ZH-CN_TOPIC_0000002441768857)**  
...
**图 1**  启动画面<a name="1-1"></a>  
![](figures/启动画面.png "启动画面")
...
-   **[方案切换](#ZH-CN_TOPIC_0000002441889037)**  

-   **[方案工具适配性](#ZH-CN_TOPIC_0000002408329616)**  
...
在工具平台菜单中【Device】 \> 【Switch Device】，选择要切换的方案，如[图1](#_Ref377548814)所示。
...
-   **[工具运行缓慢](#ZH-CN_TOPIC_0000002441768849)**  

-   **[如何获取系统中当前使用的JRE版本信息？](#ZH-CN_TOPIC_0000002408169720)**  

-   **[为什么工具放在F:\\Work!!!!!!!!!!!!!!!!!!!!!\\这样的路径下不能运行](#ZH-CN_TOPIC_0000002441768869)**  

-   **[ToolPlatform的Linux版本在Ubuntu等操作系统下使用需要注意什么？](#ZH-CN_TOPIC_0000002408329628)**  
...
>-   如果-Xmx或-XX:MaxPermSize不指定或者指定的值偏小，应用可能会导致java.lang.OutOfMemoryError错误。需要重新配置参数，重新运行ToolPlatform工具。
...
<td class="cellrowborder" valign="top" width="47%"><p id="p175mcpsimp"><a name="p175mcpsimp"></a><a name="p175mcpsimp"></a>Java开发包</p>
</td>
</tr>
</tbody>
</table>
