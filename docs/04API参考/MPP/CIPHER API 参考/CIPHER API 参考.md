...
-   **[概述](#ZH-CN_TOPIC_0000002408093758)**  

-   **[使用流程](#ZH-CN_TOPIC_0000002408253578)**  
...
-   **[对称加解密算法](#ZH-CN_TOPIC_0000002408093762)**  

-   **[不对称加解密算法](#ZH-CN_TOPIC_0000002441572925)**  

-   **[随机数生成](#ZH-CN_TOPIC_0000002408253654)**  

-   **[摘要算法](#ZH-CN_TOPIC_0000002441572917)**  

-   **[算法标准](#ZH-CN_TOPIC_0000002441653073)**  

-   **[CIPHER使用注意事项](#ZH-CN_TOPIC_0000002408093774)**  

-   **[规格差异说明](#ZH-CN_TOPIC_0000002441572921)**  
...
-   **[单包数据加解密（对称加解密算法）](#ZH-CN_TOPIC_0000002408093702)**  

-   **[多包数据加解密（对称加解密算法）](#ZH-CN_TOPIC_0000002408253610)**  

-   **[CCM/GCM加解密（对称加解密算法）](#ZH-CN_TOPIC_0000002441653033)**  

-   **[HASH计算（摘要算法）](#ZH-CN_TOPIC_0000002408253626)**  

-   **[HMAC计算（摘要算法）](#ZH-CN_TOPIC_0000002408093738)**  

-   **[随机数生成](#ZH-CN_TOPIC_0000002408093746)**  

-   **[RSA加解密（不对称加解密算法）](#ZH-CN_TOPIC_0000002441652977)**  

-   **[RSA签名及验签（不对称加解密算法）](#ZH-CN_TOPIC_0000002408093674)**  

### 单包数据加解密（对称加解密算法）<a name="ZH-CN_TOPIC_0000002408093702"></a>

-   **[场景说明](#ZH-CN_TOPIC_0000002441572877)**  

-   **[工作流程](#ZH-CN_TOPIC_0000002408093670)**  

-   **[注意事项](#ZH-CN_TOPIC_0000002441653001)**  
...
7.  加解密数据。用户可调用以下任意接口加解密数据。
    -   物理内存中数据的单包加密--[ss\_mpi\_cipher\_encrypt](#ZH-CN_TOPIC_0000002441652993)
    -   物理内存中数据的单包解密--[ss\_mpi\_cipher\_decrypt](#ZH-CN_TOPIC_0000002441572865)
    -   虚拟内存中数据的单包加密--[ss\_mpi\_cipher\_encrypt\_virt](#ZH-CN_TOPIC_0000002408253614)
    -   虚拟内存中数据的单包解密--[ss\_mpi\_cipher\_decrypt\_virt](#ZH-CN_TOPIC_0000002441572833)
...
-   **[场景说明](#ZH-CN_TOPIC_0000002441572933)**  

-   **[工作流程](#ZH-CN_TOPIC_0000002441652989)**  

-   **[注意事项](#ZH-CN_TOPIC_0000002441572861)**  
...
6.  配置密钥。请参考《KLAD API 参考》1.2.1 明文KEY传递或1.2.2 ROOTKEY传递。
7.  加解密数据。用户可调用以下任意接口加解密数据。
    -   多包加密--[ss\_mpi\_cipher\_encrypt\_multi\_pack](#ZH-CN_TOPIC_0000002408093690)
    -   多包解密--[ss\_mpi\_cipher\_decrypt\_multi\_pack](#ZH-CN_TOPIC_0000002441653025)
...
-   **[场景说明](#ZH-CN_TOPIC_0000002441572893)**  

-   **[工作流程](#ZH-CN_TOPIC_0000002441572849)**  

-   **[注意事项](#ZH-CN_TOPIC_0000002441653021)**  
...
6.  配置密钥。请参考《KLAD API 参考》1.2.1 明文KEY传递或1.2.2 ROOTKEY传递。
7.  加解密数据。用户可调用以下任意接口加解密数据。
    -   物理内存中数据加密--[ss\_mpi\_cipher\_encrypt](#ZH-CN_TOPIC_0000002441652993)
    -   物理内存中数据解密--[ss\_mpi\_cipher\_decrypt](#ZH-CN_TOPIC_0000002441572865)
    -   虚拟内存中数据加密--[ss\_mpi\_cipher\_encrypt\_virt](#ZH-CN_TOPIC_0000002408253614)
    -   虚拟内存中数据解密--[ss\_mpi\_cipher\_decrypt\_virt](#ZH-CN_TOPIC_0000002441572833)
...
-   **[场景说明](#ZH-CN_TOPIC_0000002441572829)**  

-   **[工作流程](#ZH-CN_TOPIC_0000002408253594)**  

-   **[注意事项](#ZH-CN_TOPIC_0000002441572881)**  
...
2.  创建一路HASH，获取HASH句柄，选择HASH算法。调用接口[ss\_mpi\_cipher\_hash\_init](#ZH-CN_TOPIC_0000002408093678)完成。
...
5.  完成摘要计算，结束输入，获取计算结果。调用接口[ss\_mpi\_cipher\_hash\_final](#ZH-CN_TOPIC_0000002408093722)完成。
...
-   **[场景说明](#ZH-CN_TOPIC_0000002408253646)**  

-   **[工作流程](#ZH-CN_TOPIC_0000002441572869)**  

-   **[注意事项](#ZH-CN_TOPIC_0000002441653081)**  
...
2.  调用[ss\_mpi\_cipher\_hash\_init](#ZH-CN_TOPIC_0000002408093678)选择使用的HASH算法，并配置HMAC计算的密钥，初始化HASH模块。
3.  调用[ss\_mpi\_cipher\_hash\_update](#ZH-CN_TOPIC_0000002408253598)输入数据，可以一个BLOCK接一个BLOCK输入。
4.  调用[ss\_mpi\_cipher\_hash\_final](#ZH-CN_TOPIC_0000002408093722)结束输入，并输出HMAC值。
...
-   **[场景说明](#ZH-CN_TOPIC_0000002441652997)**  

-   **[工作流程](#ZH-CN_TOPIC_0000002441653029)**  

-   **[注意事项](#ZH-CN_TOPIC_0000002408253634)**  
...
-   **[场景说明](#ZH-CN_TOPIC_0000002408253574)**  

-   **[工作流程](#ZH-CN_TOPIC_0000002408093726)**  

-   **[注意事项](#ZH-CN_TOPIC_0000002408253670)**  
...
2.  对数据进行加解密。根据使用的密钥不同，分为4个接口，用户可以调用以下任一接口进行加解密等。
    -   公钥加密--  [ss\_mpi\_cipher\_rsa\_public\_encrypt](#ZH-CN_TOPIC_0000002408253586)
    -   私钥解密--  [ss\_mpi\_cipher\_rsa\_private\_decrypt](#ZH-CN_TOPIC_0000002408093710)
    -   私钥加密--  [ss\_mpi\_cipher\_rsa\_private\_encrypt](#ZH-CN_TOPIC_0000002441653041)
    -   公钥解密--  [ss\_mpi\_cipher\_rsa\_public\_decrypt](#ZH-CN_TOPIC_0000002408253566)

3.  关闭CIPHER设备。调用接口[ss\_mpi\_cipher\_deinit](#ZH-CN_TOPIC_0000002441572905)完成。

#### 注意事项<a name="ZH-CN_TOPIC_0000002408253670"></a>

RSA密钥位宽可选2048、3072及4096。根据RSA算法原理，明文和密文都必须比公钥N小，所以待加解密的数据长度必须小于或等于密钥的长度，惯用做法是在待加解密的数据的高位补0等，使其长度和公钥N相等，但其值比公钥N小。支持PKCS\#1 V1.5和PKCS\#1 V2.1填充方式，其中PKCS\#1 V1.5为弱填充方式，客户不建议使用该填充方式，PKCS\#1 V2.1填充方式为OAEP。注意：op-tee、uboot环境不支持RSA私钥，priv\_key用p/q/dp/dq/qp代替d。

### RSA签名及验签（不对称加解密算法）<a name="ZH-CN_TOPIC_0000002408093674"></a>

-   **[场景说明](#ZH-CN_TOPIC_0000002441653017)**  

-   **[工作流程](#ZH-CN_TOPIC_0000002408093734)**  

-   **[注意事项](#ZH-CN_TOPIC_0000002441653065)**  
...
2.  对数据进行签名验证，调用以下接口签名验证。
    -   私钥签名--[ss\_mpi\_cipher\_rsa\_sign](#ZH-CN_TOPIC_0000002441653009)
    -   公钥验证--[ss\_mpi\_cipher\_rsa\_verify](#ZH-CN_TOPIC_0000002408253618)

3.  关闭CIPHER设备。调用接口[ss\_mpi\_cipher\_deinit](#ZH-CN_TOPIC_0000002441572905)完成。

#### 注意事项<a name="ZH-CN_TOPIC_0000002441653065"></a>

RSA密钥位宽可选2048、3072及4096。根据RSA算法原理，明文和密文都必须比公钥小，所以待加解密的数据长度必须小于或等于密钥的长度，惯用做法是先计算待签名数据的HASH值，接着将HASH值填充成长度和公钥N相等但其值比公钥N小的数据，然后再进行加密。支持PKCS\#1 V1.5和PKCS\#1 V2.1填充方式，其中PKCS\#1 V1.5为弱填充方式，客户不要该填充方式，PKCS\#1 V2.1填充方式为PSS。注意：op-tee、uboot环境不支持RSA私钥，priv\_key用p/q/dp/dq/qp代替d。
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p595mcpsimp"><a name="p595mcpsimp"></a><a name="p595mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p664mcpsimp"><a name="p664mcpsimp"></a><a name="p664mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p725mcpsimp"><a name="p725mcpsimp"></a><a name="p725mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p794mcpsimp"><a name="p794mcpsimp"></a><a name="p794mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p863mcpsimp"><a name="p863mcpsimp"></a><a name="p863mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p945mcpsimp"><a name="p945mcpsimp"></a><a name="p945mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
-   CIPHER句柄必须已创建。
-   可多次调用，需配合  [ss\_mpi\_cipher\_set\_cfg](#ZH-CN_TOPIC_0000002408253622)  使用，使用方法可参考  [注意事项](#ZH-CN_TOPIC_0000002441653001)。
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p1029mcpsimp"><a name="p1029mcpsimp"></a><a name="p1029mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p1113mcpsimp"><a name="p1113mcpsimp"></a><a name="p1113mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p1197mcpsimp"><a name="p1197mcpsimp"></a><a name="p1197mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p1276mcpsimp"><a name="p1276mcpsimp"></a><a name="p1276mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p1357mcpsimp"><a name="p1357mcpsimp"></a><a name="p1357mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p1435mcpsimp"><a name="p1435mcpsimp"></a><a name="p1435mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p1507mcpsimp"><a name="p1507mcpsimp"></a><a name="p1507mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p1581mcpsimp"><a name="p1581mcpsimp"></a><a name="p1581mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p1657mcpsimp"><a name="p1657mcpsimp"></a><a name="p1657mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p1715mcpsimp"><a name="p1715mcpsimp"></a><a name="p1715mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p1811mcpsimp"><a name="p1811mcpsimp"></a><a name="p1811mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p1907mcpsimp"><a name="p1907mcpsimp"></a><a name="p1907mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p2003mcpsimp"><a name="p2003mcpsimp"></a><a name="p2003mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p2099mcpsimp"><a name="p2099mcpsimp"></a><a name="p2099mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p2195mcpsimp"><a name="p2195mcpsimp"></a><a name="p2195mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p2291mcpsimp"><a name="p2291mcpsimp"></a><a name="p2291mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p2369mcpsimp"><a name="p2369mcpsimp"></a><a name="p2369mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p2448mcpsimp"><a name="p2448mcpsimp"></a><a name="p2448mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p2527mcpsimp"><a name="p2527mcpsimp"></a><a name="p2527mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p2606mcpsimp"><a name="p2606mcpsimp"></a><a name="p2606mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p2676mcpsimp"><a name="p2676mcpsimp"></a><a name="p2676mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p2737mcpsimp"><a name="p2737mcpsimp"></a><a name="p2737mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p2804mcpsimp"><a name="p2804mcpsimp"></a><a name="p2804mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p id="p2871mcpsimp"><a name="p2871mcpsimp"></a><a name="p2871mcpsimp"></a>参见<a href="#ZH-CN_TOPIC_0000002408253662">错误码</a>。</p>
</td>
</tr>
</tbody>
</table>
...
-   [ot\_cipher\_ctrl](#ZH-CN_TOPIC_0000002441652985)
-   [ss\_mpi\_cipher\_set\_cfg](#ZH-CN_TOPIC_0000002408253622)
-   [ss\_mpi\_cipher\_get\_cfg](#ZH-CN_TOPIC_0000002441572913)
...
-   [ot\_cipher\_ctrl\_aes](#ZH-CN_TOPIC_0000002408253582)
-   [ot\_cipher\_ctrl\_aes\_ccm\_gcm](#ZH-CN_TOPIC_0000002441572857)
-   [ot\_cipher\_ctrl](#ZH-CN_TOPIC_0000002441652985)
-   [ss\_mpi\_cipher\_set\_cfg](#ZH-CN_TOPIC_0000002408253622)
-   [ss\_mpi\_cipher\_get\_cfg](#ZH-CN_TOPIC_0000002441572913)
...
-   [ot\_cipher\_ctrl\_aes](#ZH-CN_TOPIC_0000002408253582)
-   [ot\_cipher\_ctrl\_sm4](#ZH-CN_TOPIC_0000002408253642)
-   [ot\_cipher\_ctrl](#ZH-CN_TOPIC_0000002441652985)
-   [ss\_mpi\_cipher\_set\_cfg](#ZH-CN_TOPIC_0000002408253622)
-   [ss\_mpi\_cipher\_get\_cfg](#ZH-CN_TOPIC_0000002441572913)
...
-   [ot\_cipher\_attr](#ZH-CN_TOPIC_0000002408093754)
-   [ss\_mpi\_cipher\_create](#ZH-CN_TOPIC_0000002408253570)
...
<tbody><tr id="row3383mcpsimp"><td class="cellrowborder" valign="top" width="63%" headers="mcps1.1.3.1.1 "><p id="p3385mcpsimp"><a name="p3385mcpsimp"></a><a name="p3385mcpsimp"></a>iv[<a href="#ZH-CN_TOPIC_0000002441652981">OT_CIPHER_MAX_IV_SIZE_IN_WORD</a>]</p>
</td>
...
<tbody><tr id="row3446mcpsimp"><td class="cellrowborder" valign="top" width="56.99999999999999%" headers="mcps1.1.3.1.1 "><p id="p3448mcpsimp"><a name="p3448mcpsimp"></a><a name="p3448mcpsimp"></a>iv[<a href="#ZH-CN_TOPIC_0000002441652981">OT_CIPHER_MAX_IV_SIZE_IN_WORD</a>]</p>
</td>
...
<tbody><tr id="row3516mcpsimp"><td class="cellrowborder" valign="top" width="54%" headers="mcps1.1.3.1.1 "><p id="p3518mcpsimp"><a name="p3518mcpsimp"></a><a name="p3518mcpsimp"></a><span xml:lang="de-DE" id="ph3519mcpsimp"><a name="ph3519mcpsimp"></a><a name="ph3519mcpsimp"></a>iv[</span><a href="#ZH-CN_TOPIC_0000002441652981">OT_CIPHER_MAX_IV_SIZE_IN_WORD</a><span xml:lang="de-DE" id="ph3521mcpsimp"><a name="ph3521mcpsimp"></a><a name="ph3521mcpsimp"></a>]</span></p>
</td>
...
-   [ss\_mpi\_cipher\_encrypt\_multi\_pack](#ZH-CN_TOPIC_0000002408093690)
-   [ss\_mpi\_cipher\_decrypt\_multi\_pack](#ZH-CN_TOPIC_0000002441653025)
...
-   [ot\_cipher\_hash\_attr](#ZH-CN_TOPIC_0000002408253650)
-   [ss\_mpi\_cipher\_hash\_init](#ZH-CN_TOPIC_0000002408093678)
...
-   [ss\_mpi\_cipher\_rsa\_public\_encrypt](#ZH-CN_TOPIC_0000002408253586)
-   [ss\_mpi\_cipher\_rsa\_private\_decrypt](#ZH-CN_TOPIC_0000002408093710)
-   [ss\_mpi\_cipher\_rsa\_private\_encrypt](#ZH-CN_TOPIC_0000002441653041)
-   [ss\_mpi\_cipher\_rsa\_public\_decrypt](#ZH-CN_TOPIC_0000002408253566)
-   [ss\_mpi\_cipher\_rsa\_sign](#ZH-CN_TOPIC_0000002441653009)
-   [ss\_mpi\_cipher\_rsa\_verify](#ZH-CN_TOPIC_0000002408253618)
-   [ss\_mpi\_cipher\_sm2\_encrypt](#ZH-CN_TOPIC_0000002441572901)
-   [ss\_mpi\_cipher\_sm2\_decrypt](#ZH-CN_TOPIC_0000002441653061)
...
-   [ss\_mpi\_cipher\_rsa\_sign](#ZH-CN_TOPIC_0000002441653009)
-   [ss\_mpi\_cipher\_rsa\_verify](#ZH-CN_TOPIC_0000002408253618)
-   [ss\_mpi\_cipher\_sm2\_sign](#ZH-CN_TOPIC_0000002408253606)
-   [ss\_mpi\_cipher\_sm2\_verify](#ZH-CN_TOPIC_0000002408093770)
...
-   [ot\_keyslot\_attr](#ZH-CN_TOPIC_0000002408093730)
-   [ss\_mpi\_keyslot\_create](#ZH-CN_TOPIC_0000002441572909)
...
-   [ot\_cipher\_sm2\_public\_key](#ZH-CN_TOPIC_0000002408093742)
-   [ot\_cipher\_sm2\_private\_key](#ZH-CN_TOPIC_0000002441572841)
-   [ot\_cipher\_sm2\_sign](#ZH-CN_TOPIC_0000002441653013)
-   [ot\_cipher\_sm2\_verify](#ZH-CN_TOPIC_0000002441572885)
-   [ot\_cipher\_sm2\_sign\_data](#ZH-CN_TOPIC_0000002441653045)
...
-   **[CIPHER状态](#ZH-CN_TOPIC_0000002408093750)**  
