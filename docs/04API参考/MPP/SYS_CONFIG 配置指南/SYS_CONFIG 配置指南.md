...
-   **[SYS\_CONFIG介绍](#ZH-CN_TOPIC_0000002441701425)**  
...
-   **[VI VPSS在线离线模式](#ZH-CN_TOPIC_0000002441701441)**  
...
-   **[VI VPSS在线离线模式配置](#ZH-CN_TOPIC_0000002408102290)**  
...
-   **[VI 时钟复位配置](#ZH-CN_TOPIC_0000002441701453)**  

-   **[SPI时钟](#ZH-CN_TOPIC_0000002408102226)**  

## VI 时钟复位配置<a name="ZH-CN_TOPIC_0000002441701453"></a>

-   **[VICAP时钟](#ZH-CN_TOPIC_0000002408262174)**  

-   **[PORT口时钟](#ZH-CN_TOPIC_0000002408102198)**  

-   **[CMOS时钟](#ZH-CN_TOPIC_0000002408262118)**  

-   **[SENSOR时钟](#ZH-CN_TOPIC_0000002408262078)**  

-   **[VIPROC时钟](#ZH-CN_TOPIC_0000002441701365)**  
...
-   **[I2C总线管脚复用](#ZH-CN_TOPIC_0000002441701329)**  

-   **[SPI总线管脚复用](#ZH-CN_TOPIC_0000002441661509)**  

-   **[VI管脚复用](#ZH-CN_TOPIC_0000002441661573)**  

-   **[VO管脚复用](#ZH-CN_TOPIC_0000002408102214)**  

-   **[Audio管脚复用](#ZH-CN_TOPIC_0000002408262062)**  
...
-   **[I2C管脚复用](#ZH-CN_TOPIC_0000002441701345)**  
...
-   **[时钟管脚配置（AM19）](#ZH-CN_TOPIC_0000002441701373)**  

-   **[DATA管脚配置（AM20）](#ZH-CN_TOPIC_0000002441701409)**  
...
-   **[SPI管脚复用](#ZH-CN_TOPIC_0000002441661537)**  
...
-   **[PORT口管脚复用](#ZH-CN_TOPIC_0000002441661521)**  

### PORT口管脚复用<a name="ZH-CN_TOPIC_0000002441661521"></a>

-   **[MIPI\_RX管脚复用](#ZH-CN_TOPIC_0000002408102178)**  

-   **[BT.656管脚复用](#ZH-CN_TOPIC_0000002408262106)**  

-   **[BT.1120管脚复用](#ZH-CN_TOPIC_0000002408102242)**  

-   **[SENSOR参考时钟管脚](#ZH-CN_TOPIC_0000002441661473)**  
...
-   DATA管脚配置：
    ...
    VI\_DATA0\~VI\_DATA7为对应的BT.656接口的相关功能，可参考“[BT.656管脚复用](#ZH-CN_TOPIC_0000002408262106)”章节的相关描述进行配置。
...
-   **[HDMI管脚复用](#ZH-CN_TOPIC_0000002408262158)**  

-   **[MIPI\_TX管脚复用](#ZH-CN_TOPIC_0000002408102166)**  

-   **[BT.1120管脚复用](#ZH-CN_TOPIC_0000002408262142)**  

-   **[BT.656管脚复用](#ZH-CN_TOPIC_0000002408102278)**  

-   **[RGB管脚复用](#ZH-CN_TOPIC_0000002441701393)**  
...
VO BT.656接口功能管脚采用VO BT.1120接口的DATA0\~DATA7，这些管脚的驱动能力由MIPI\_TX控制寄存器来配置，方法可参考“[BT.1120管脚复用](#ZH-CN_TOPIC_0000002408262142)”小节，默认配置为档位3。

### RGB管脚复用<a name="ZH-CN_TOPIC_0000002441701393"></a>
...
-   **[功放GPIO管脚复用](#ZH-CN_TOPIC_0000002441661489)**  
