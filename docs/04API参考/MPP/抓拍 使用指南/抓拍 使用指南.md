...
-   **[概述](#ZH-CN_TOPIC_0000002441723221)**  

-   **[重要概念](#ZH-CN_TOPIC_0000002441683353)**  

-   **[抓拍数据通路](#ZH-CN_TOPIC_0000002408124058)**  

-   **[功能描述](#ZH-CN_TOPIC_0000002408283970)**  

-   **[错误码](#ZH-CN_TOPIC_0000002408283958)**  
...
-   **[双pipe离线模式拍照](#ZH-CN_TOPIC_0000002441683357)**  

-   **[单pipe离线模式拍照](#ZH-CN_TOPIC_0000002408124062)**  

-   **[单pipe在线模式拍照](#ZH-CN_TOPIC_0000002441683349)**  

-   **[ZSL模式拍照](#ZH-CN_TOPIC_0000002441723225)**  
...
-   **[连拍时的帧率控制](#ZH-CN_TOPIC_0000002441723157)**  
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p1233mcpsimp"><a name="p1233mcpsimp"></a><a name="p1233mcpsimp"></a>失败，其值为<a href="#ZH-CN_TOPIC_0000002408283958">错误码</a><span xml:lang="fr-FR" id="ph1235mcpsimp"><a name="ph1235mcpsimp"></a><a name="ph1235mcpsimp"></a>。</span></p>
</td>
</tr>
</tbody>
</table>
...
-   在调用[ss\_mpi\_snap\_enable\_pipe](#ZH-CN_TOPIC_0000002408124010)接口之后，再次调用ss\_mpi\_snap\_set\_pipe\_attr接口时，只能修改成员[ot\_snap\_attr](#ZH-CN_TOPIC_0000002441723169)的pro\_attr属性，修改其他属性都会报错。
...
<p id="p1009mcpsimp"><a name="p1009mcpsimp"></a><a name="p1009mcpsimp"></a>取值范围：[0, <a href="#OT_VI_MAX_PHYS_PIPE_NUM">OT_VI_MAX_PHYS_PIPE_NUM</a>)。</p>
</td>
...
<p id="p1808mcpsimp"><a name="p1808mcpsimp"></a><a name="p1808mcpsimp"></a>取值范围：[0, <a href="#OT_VI_MAX_PHYS_PIPE_NUM">OT_VI_MAX_PHYS_PIPE_NUM</a>)。</p>
</td>
...
-   双pipe拍照场景，使能拍照PIPE只能调用ss\_mpi\_snap\_enable\_pipe，而不能调用ss\_mpi\_vi\_start\_pipe接口，ss\_mpi\_vi\_start\_pipe的详细功能描述，请参考《MPP 媒体处理软件V5.0 开发参考》中“视频输入”章节的说明。
-   不支持重复使能拍照的PIPE。
-   双PIPE拍照时，ss\_mpi\_snap\_enable\_pipe和[ss\_mpi\_snap\_trigger\_pipe](#ZH-CN_TOPIC_0000002441683321)两个接口的调用间隔要大于2帧的曝光时间，才能使拍照的ISP处理效果正常。
-   PRO模式拍照时，[ss\_mpi\_snap\_disable\_pipe](#ZH-CN_TOPIC_0000002408283910)和ss\_mpi\_snap\_enable\_pipe两个接口的调用间隔要大于4帧，即两次拍照的间隔，在低帧率下间隔过小，第二次拍照的帧可能不是期望的曝光帧。
...
<p id="p842mcpsimp"><a name="p842mcpsimp"></a><a name="p842mcpsimp"></a>取值范围：[0, <a href="#OT_VI_MAX_PHYS_PIPE_NUM">OT_VI_MAX_PHYS_PIPE_NUM</a>)。</p>
</td>
...
<p id="p2666mcpsimp"><a name="p2666mcpsimp"></a><a name="p2666mcpsimp"></a>取值范围：[0, <a href="#OT_VI_MAX_PHYS_PIPE_NUM">OT_VI_MAX_PHYS_PIPE_NUM</a>)。</p>
</td>
...
-   **[概述](#ZH-CN_TOPIC_0000002441683337)**  

-   **[重要概念](#ZH-CN_TOPIC_0000002408124006)**  

-   **[功能描述](#ZH-CN_TOPIC_0000002408283942)**  

-   **[错误码](#ZH-CN_TOPIC_0000002441723193)**  
...
-   **[概述](#ZH-CN_TOPIC_0000002408283938)**  

-   **[数据通路](#ZH-CN_TOPIC_0000002408283914)**  

-   **[程序调用流程](#ZH-CN_TOPIC_0000002408283906)**  
