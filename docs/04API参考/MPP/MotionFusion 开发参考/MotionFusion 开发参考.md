...
-   **[概述](#ZH-CN_TOPIC_0000002408262102)**  

-   **[基本概念](#ZH-CN_TOPIC_0000002441661609)**  
...
-   温漂
    ...
    不同温度下，设备器件的零偏值可能不同。不同温度下对应的零偏我们称之为温漂。
...
-   [ss\_mpi\_mfusion\_set\_gyro\_temperature\_drift](#ZH-CN_TOPIC_0000002408262230)：设置Gyro温漂参数。
-   [ss\_mpi\_mfusion\_get\_gyro\_temperature\_drift](#ZH-CN_TOPIC_0000002441701449)：获取Gyro温漂参数。
-   [ss\_mpi\_mfusion\_set\_gyro\_online\_temperature\_drift](#ZH-CN_TOPIC_0000002441661621)：设置Gyro在线温漂。
-   [ss\_mpi\_mfusion\_get\_gyro\_online\_temperature\_drift](#ZH-CN_TOPIC_0000002441701513)：获取Gyro在线温漂。
...
<td class="cellrowborder" valign="top" width="63%" headers="mcps1.1.4.1.2 "><p id="p2387mcpsimp"><a name="p2387mcpsimp"></a><a name="p2387mcpsimp"></a>零偏属性。</p>
</td>
...
-   设置Gyro零偏功能与设置Gyro在线零偏、设置Gyro温漂参数、设置Gyro在线温漂参数互斥，其中一种功能使能之后，其余功能将使能失败。
...
<tr id="row2454mcpsimp"><td class="cellrowborder" valign="top" width="21%" headers="mcps1.1.4.1.1 "><p id="p2456mcpsimp"><a name="p2456mcpsimp"></a><a name="p2456mcpsimp"></a>gyro_drift</p>
</td>
<td class="cellrowborder" valign="top" width="63%" headers="mcps1.1.4.1.2 "><p id="p2458mcpsimp"><a name="p2458mcpsimp"></a><a name="p2458mcpsimp"></a>零偏属性。</p>
</td>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.4.1.2 "><p id="p2665mcpsimp"><a name="p2665mcpsimp"></a><a name="p2665mcpsimp"></a>温漂属性。</p>
</td>
...
-   设置Gyro温漂参数功能与设置Gyro在线温漂参数、设置Gyro零偏、Gyro在线零偏互斥，其中一种功能使能之后，其余功能将使能失败。
...
<td class="cellrowborder" valign="top" width="56.99999999999999%" headers="mcps1.1.4.1.2 "><p id="p2736mcpsimp"><a name="p2736mcpsimp"></a><a name="p2736mcpsimp"></a>温漂属性。</p>
</td>
...
<tr id="row2803mcpsimp"><td class="cellrowborder" valign="top" width="32%" headers="mcps1.1.4.1.1 "><p id="p2805mcpsimp"><a name="p2805mcpsimp"></a><a name="p2805mcpsimp"></a>temperature_drift</p>
</td>
<td class="cellrowborder" valign="top" width="52%" headers="mcps1.1.4.1.2 "><p id="p2807mcpsimp"><a name="p2807mcpsimp"></a><a name="p2807mcpsimp"></a>温漂属性。</p>
</td>
...
-   陀螺仪在线温漂功能开启时，需要通过temperature\_drift设置上一次保存的在线温漂参数。
-   陀螺仪在线温漂功能开启后，后台会自动进行在线温漂标定，与防抖业务是否开启无关。
-   系统退出前，陀螺仪在线温漂功能需要保持关闭状态，使相关资源得到释放，并使用[ss\_mpi\_mfusion\_get\_gyro\_online\_temperature\_drift](#ZH-CN_TOPIC_0000002441701513)保存最新的温漂参数。以便下次启动时使用。
-   DV模式，采用陀螺仪在线温漂功能。
-   设置Gyro在线温漂参数功能与设置Gyro温漂参数、设置Gyro零偏、设置Gyro在线零偏互斥，其中一种功能使能之后，其余功能将使能失败。
...
[ss\_mpi\_mfusion\_get\_gyro\_online\_temperature\_drift](#ZH-CN_TOPIC_0000002441701513)
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.4.1.2 "><p id="p134mcpsimp"><a name="p134mcpsimp"></a><a name="p134mcpsimp"></a>温漂属性。</p>
</td>
...
<td class="cellrowborder" valign="top" width="56.99999999999999%" headers="mcps1.1.4.1.2 "><p id="p204mcpsimp"><a name="p204mcpsimp"></a><a name="p204mcpsimp"></a>零偏属性。</p>
</td>
...
-   设置Gyro在线零偏功能与设置Gyro零偏、设置Gyro温漂参数、设置Gyro在线温漂参数互斥，其中一种功能使能之后，其余功能将使能失败。
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.4.1.2 "><p id="p278mcpsimp"><a name="p278mcpsimp"></a><a name="p278mcpsimp"></a>零偏属性。</p>
</td>
...
-   [OT\_MFUSION\_MATRIX\_TEMPERATURE\_NUM](#ZH-CN_TOPIC_0000002408262238)：定义motionfusion设备的温漂系数矩阵的元素个数。
-   [OT\_MFUSION\_TEMPERATURE\_LUT\_SAMPLES](#ZH-CN_TOPIC_0000002441661689)：定义motionfusion设备的温漂查找表的采样个数。
...
-   [OT\_MFUSION\_TEMPERATURE\_OFFSET\_GRADINT](#ZH-CN_TOPIC_0000002441701353)：定义温漂参数的精度。
-   [OT\_MFUSION\_COMMON\_BUF\_SIZE](#ZH-CN_TOPIC_0000002441661681)：定义motionfusion采样数据大小。
-   [OT\_MFUSION\_LUT\_STATUS\_NUM](#ZH-CN_TOPIC_0000002441701397)：定义温漂查找表状态数目。
...
-   [ot\_mfusion\_temperature\_drift\_mode](#ZH-CN_TOPIC_0000002441701437)：定义温漂模式。
-   [ot\_mfusion\_temperature\_drift\_lut](#ZH-CN_TOPIC_0000002441661517)：定义温漂的查找表数据类型。
-   [ot\_mfusion\_temperature\_drift](#ZH-CN_TOPIC_0000002408102298)：定义温漂属性。
...
[ot\_mfusion\_temperature\_drift\_lut](#ZH-CN_TOPIC_0000002441661517)
...
<td class="cellrowborder" valign="top" width="57.99999999999999%" headers="mcps1.1.3.1.2 "><p xml:lang="sv-SE" id="p611mcpsimp"><a name="p611mcpsimp"></a><a name="p611mcpsimp"></a>静止状态时间阈值，单位为秒。连续检测到超过此配置时长的静止状态才启动在线温漂标定。</p>
...
<td class="cellrowborder" valign="top" width="63%" headers="mcps1.1.3.1.2 "><p xml:lang="sv-SE" id="p806mcpsimp"><a name="p806mcpsimp"></a><a name="p806mcpsimp"></a><span xml:lang="de-DE" id="ph807mcpsimp"><a name="ph807mcpsimp"></a><a name="ph807mcpsimp"></a>Gyro数据数组。数组最大为</span><a href="#ZH-CN_TOPIC_0000002441661681">OT_MFUSION_COMMON_BUF_SIZE</a></p>
</td>
</tr>
...
-   [OT\_MFUSION\_COMMON\_BUF\_SIZE](#ZH-CN_TOPIC_0000002441661681)
-   [ot\_mfusion\_sample\_data](#ZH-CN_TOPIC_0000002441701465)
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p xml:lang="sv-SE" id="p855mcpsimp"><a name="p855mcpsimp"></a><a name="p855mcpsimp"></a><span xml:lang="de-DE" id="ph856mcpsimp"><a name="ph856mcpsimp"></a><a name="ph856mcpsimp"></a>ACC数据数组。数组最大为</span><a href="#ZH-CN_TOPIC_0000002441661681">OT_MFUSION_COMMON_BUF_SIZE</a></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="48%" headers="mcps1.1.3.1.2 "><p xml:lang="sv-SE" id="p903mcpsimp"><a name="p903mcpsimp"></a><a name="p903mcpsimp"></a>温漂的多项式曲线模式。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="48%" headers="mcps1.1.3.1.2 "><p xml:lang="sv-SE" id="p910mcpsimp"><a name="p910mcpsimp"></a><a name="p910mcpsimp"></a>温漂的查找表模式。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p xml:lang="sv-SE" id="p946mcpsimp"><a name="p946mcpsimp"></a><a name="p946mcpsimp"></a>设备的温漂查找表数组。每个采样点下记录x、y、z三个轴的温漂数据。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p xml:lang="sv-SE" id="p951mcpsimp"><a name="p951mcpsimp"></a><a name="p951mcpsimp"></a>温漂查找表的状态信息。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p xml:lang="sv-SE" id="p956mcpsimp"><a name="p956mcpsimp"></a><a name="p956mcpsimp"></a>温漂查找表的最小温度值。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="64%" headers="mcps1.1.3.1.2 "><p xml:lang="sv-SE" id="p961mcpsimp"><a name="p961mcpsimp"></a><a name="p961mcpsimp"></a>温漂查找表的最大温度值。</p>
</td>
</tr>
...
-   首次初始化时，温漂查找表的状态信息需设置成INT\_MAX（0x7fffffff）。
-   系统下电前需保存结构信息到flash，下次上电时将此信息设置到系统中。

【相关数据类型及接口】

-   [OT\_MFUSION\_TEMPERATURE\_LUT\_SAMPLES](#ZH-CN_TOPIC_0000002441661689)
-   [OT\_MFUSION\_AXIS\_NUM](#ZH-CN_TOPIC_0000002408102346)
...
<td class="cellrowborder" valign="top" width="71%" headers="mcps1.1.3.1.2 "><p id="p1014mcpsimp"><a name="p1014mcpsimp"></a><a name="p1014mcpsimp"></a>温漂或在线温漂使能。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="71%" headers="mcps1.1.3.1.2 "><p xml:lang="sv-SE" id="p1019mcpsimp"><a name="p1019mcpsimp"></a><a name="p1019mcpsimp"></a><span xml:lang="en-US" id="ph1020mcpsimp"><a name="ph1020mcpsimp"></a><a name="ph1020mcpsimp"></a>温漂模式，</span>多项式系数拟合曲线模式或者查找表模式。</p>
</td>
</tr>
...
-   [ot\_mfusion\_temperature\_drift\_mode](#ZH-CN_TOPIC_0000002441701437)
-   [OT\_MFUSION\_MATRIX\_TEMPERATURE\_NUM](#ZH-CN_TOPIC_0000002408262238)
-   [ot\_mfusion\_temperature\_drift\_lut](#ZH-CN_TOPIC_0000002441661517)
...
[OT\_MFUSION\_MATRIX\_NUM](#ZH-CN_TOPIC_0000002441701485)
...
-   **[motionsensor proc](#ZH-CN_TOPIC_0000002408262126)**  

-   **[motionfusion proc](#ZH-CN_TOPIC_0000002441661645)**  

-   **[gyrodis proc](#ZH-CN_TOPIC_0000002408262194)**  

## motionsensor proc<a name="ZH-CN_TOPIC_0000002408262126"></a>

-   **[motionsensor\_chip proc](#ZH-CN_TOPIC_0000002408262222)**  

-   **[motionsensor\_mng proc](#ZH-CN_TOPIC_0000002441661597)**  
...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.1 "><p id="p1533mcpsimp"><a name="p1533mcpsimp"></a><a name="p1533mcpsimp"></a>静止检测参数，参考本文档<a href="#ZH-CN_TOPIC_0000002441701533">ot_mfusion_steady_detect_attr</a>的描述。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.1 "><p id="p14671245191518"><a name="p14671245191518"></a><a name="p14671245191518"></a>静止检测参数，参考本文档<a href="#ZH-CN_TOPIC_0000002441701533">ot_mfusion_steady_detect_attr</a>的描述。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.1 "><p id="p34733450154"><a name="p34733450154"></a><a name="p34733450154"></a>静止检测参数，参考本文档<a href="#ZH-CN_TOPIC_0000002441701533">ot_mfusion_steady_detect_attr</a>的描述。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.1 "><p id="p1847894551518"><a name="p1847894551518"></a><a name="p1847894551518"></a>静止检测参数，参考本文档<a href="#ZH-CN_TOPIC_0000002441701533">ot_mfusion_steady_detect_attr</a>的描述。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.1 "><p id="p174831445111518"><a name="p174831445111518"></a><a name="p174831445111518"></a>静止检测参数，参考本文档<a href="#ZH-CN_TOPIC_0000002441701533">ot_mfusion_steady_detect_attr</a>的描述。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.1 "><p id="p14881245171513"><a name="p14881245171513"></a><a name="p14881245171513"></a>静止检测参数，参考本文档<a href="#ZH-CN_TOPIC_0000002441701533">ot_mfusion_steady_detect_attr</a>的描述。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.1 "><p id="p1249344515152"><a name="p1249344515152"></a><a name="p1249344515152"></a>静止检测参数，参考本文档<a href="#ZH-CN_TOPIC_0000002441701533">ot_mfusion_steady_detect_attr</a>的描述。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.1 "><p id="p1849810456153"><a name="p1849810456153"></a><a name="p1849810456153"></a>静止检测参数，参考本文档<a href="#ZH-CN_TOPIC_0000002441701533">ot_mfusion_steady_detect_attr</a>的描述。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.1 "><p id="p750212456153"><a name="p750212456153"></a><a name="p750212456153"></a>静止检测参数，参考本文档<a href="#ZH-CN_TOPIC_0000002441701533">ot_mfusion_steady_detect_attr</a>的描述。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.4.1.2 "><p id="p1630mcpsimp"><a name="p1630mcpsimp"></a><a name="p1630mcpsimp"></a>陀螺仪温漂开关。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.1 "><p id="p1635mcpsimp"><a name="p1635mcpsimp"></a><a name="p1635mcpsimp"></a>陀螺仪温漂模式：</p>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.1 "><p id="p1647mcpsimp"><a name="p1647mcpsimp"></a><a name="p1647mcpsimp"></a>温漂表（lut模式显示）。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.4.1.2 "><p id="p1654mcpsimp"><a name="p1654mcpsimp"></a><a name="p1654mcpsimp"></a>陀螺仪在线温漂开关。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.1 "><p id="p1659mcpsimp"><a name="p1659mcpsimp"></a><a name="p1659mcpsimp"></a>陀螺仪在线温漂模式：</p>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.1 "><p id="p1671mcpsimp"><a name="p1671mcpsimp"></a><a name="p1671mcpsimp"></a>温漂表的最小温度，精度2^10（lut模式显示）。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.1 "><p id="p1676mcpsimp"><a name="p1676mcpsimp"></a><a name="p1676mcpsimp"></a>温漂表的最大温度，精度2^10（lut模式显示）。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.1 "><p id="p1681mcpsimp"><a name="p1681mcpsimp"></a><a name="p1681mcpsimp"></a>温漂表的step，精度2^10（lut模式显示）。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.1 "><p id="p1686mcpsimp"><a name="p1686mcpsimp"></a><a name="p1686mcpsimp"></a>温漂表（lut模式显示）。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.1.4.1.2 "><p id="p1717mcpsimp"><a name="p1717mcpsimp"></a><a name="p1717mcpsimp"></a>加速度计温漂开关。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.1.4.1.1 "><p id="p1722mcpsimp"><a name="p1722mcpsimp"></a><a name="p1722mcpsimp"></a>加速度计温漂值。</p>
</td>
</tr>
