...
-   **[GFBG简介](#ZH-CN_TOPIC_0000002408095650)**  

-   **[GFBG与Linux Framebuffer对比](#ZH-CN_TOPIC_0000002441694837)**  

-   **[相关文档](#ZH-CN_TOPIC_0000002408255610)**  
...
-   **[体系结构](#ZH-CN_TOPIC_0000002408255614)**  

-   **[应用场景](#ZH-CN_TOPIC_0000002441655009)**  
...
-   **[叠加图形层管理](#ZH-CN_TOPIC_0000002441655017)**  

-   **[解决方案差异](#ZH-CN_TOPIC_0000002408255606)**  

-   **[时序控制](#ZH-CN_TOPIC_0000002408095654)**  

-   **[标准功能与扩展功能](#ZH-CN_TOPIC_0000002408255602)**  

-   **[图形层刷新类型——FB扩展模式](#ZH-CN_TOPIC_0000002441694841)**  

-   **[图形层压缩](#ZH-CN_TOPIC_0000002441694853)**  
...
>![](public_sys-resources/icon-note.gif) **说明：** 
>上文提到的三个分辨率：画布分辨率（即用户绘制buffer的分辨率）、显存分辨率、屏幕显示分辨率。绘图内容从用户绘制buffer到显示buffer的过程支持缩放，也支持抗闪烁；而从显示buffer到显示设备的过程支持缩放，不支持抗闪，显存分辨率与屏幕显示分辨率默认相同，可以通过FBIOPUT\_SCREEN\_SIZE接口设置屏幕分辨率。
...
-   **[原理介绍](#ZH-CN_TOPIC_0000002408095666)**  

-   **[参数设置](#ZH-CN_TOPIC_0000002441694845)**  

-   **[配置举例](#ZH-CN_TOPIC_0000002441694849)**  

-   **[异常情况](#ZH-CN_TOPIC_0000002408255618)**  
...
-   **[参数video](#ZH-CN_TOPIC_0000002408095662)**  

-   **[参数softcursor](#ZH-CN_TOPIC_0000002441655013)**  

-   **[参数g\_layer\_mmz\_names](#ZH-CN_TOPIC_0000002441655021)**  

-   **[参数默认值](#ZH-CN_TOPIC_0000002408255598)**  
...
-   **[开发流程](#ZH-CN_TOPIC_0000002441655025)**  

-   **[实例介绍](#ZH-CN_TOPIC_0000002408095646)**  
