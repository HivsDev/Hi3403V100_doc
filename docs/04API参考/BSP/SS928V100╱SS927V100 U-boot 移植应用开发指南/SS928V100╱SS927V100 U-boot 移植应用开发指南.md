...
-   **[概述](#ZH-CN_TOPIC_0000002457834693)**  

-   **[U-boot目录结构](#ZH-CN_TOPIC_0000002457874789)**  
...
<td class="cellrowborder" valign="top" width="59%" headers="mcps1.2.3.1.2 "><p id="p231mcpsimp"><a name="p231mcpsimp"></a><a name="p231mcpsimp"></a>特定体系结构的相关代码，如ARM、MIPS的通用代码。</p>
</td>
</tr>
...
-   **[U-boot硬件环境](#ZH-CN_TOPIC_0000002424355914)**  

-   **[编译U-boot](#ZH-CN_TOPIC_0000002457834689)**  

-   **[配置DDR存储器](#ZH-CN_TOPIC_0000002457874801)**  

-   **[配置管脚复用](#ZH-CN_TOPIC_0000002457874785)**  

-   **[生成最终使用的U-boot镜像](#ZH-CN_TOPIC_0000002457834697)**  
...
-   **[概述](#ZH-CN_TOPIC_0000002457834677)**  

-   **[通过bootrom工具烧写U-boot](#ZH-CN_TOPIC_0000002424355918)**  

-   **[Flash的U-boot烧写方法](#ZH-CN_TOPIC_0000002424355886)**  

-   **[eMMC的U-boot烧写方法](#ZH-CN_TOPIC_0000002424196070)**  
...
-   **[SPI -Nor Flash烧写方法](#ZH-CN_TOPIC_0000002457874813)**  

-   **[SPI-Nand Flash烧写方法](#ZH-CN_TOPIC_0000002424355910)**  
...
-   **[概述](#ZH-CN_TOPIC_0000002424196046)**  

-   **[ARM调试工具简介](#ZH-CN_TOPIC_0000002424355906)**  

-   **[使用ARM调试工具](#ZH-CN_TOPIC_0000002457834669)**  

-   **[使用仿真器烧写Flash](#ZH-CN_TOPIC_0000002424196054)**  
...
-   **[DS-5 Eclipse](#ZH-CN_TOPIC_0000002424196042)**  

-   **[DS-5 Debug](#ZH-CN_TOPIC_0000002424355894)**  
...
-   **[安装ARM Development Studio 5](#ZH-CN_TOPIC_0000002457874781)**  

-   **[新建目标平台配置数据库](#ZH-CN_TOPIC_0000002457834681)**  

-   **[连接目标平台](#ZH-CN_TOPIC_0000002424196058)**  
...
1.  返回DS-5 Eclipse界面，选择【Automatic/simple platform detection\(Recommended\)】点击下一步，系统会自动进行扫描，将仿真器IP地址输入【Connection Address】，点击【Next \>】，勾选上Debug target after saving configuration，点击【Next \>】，点击【Create New Database】，输入名字，点击【OK】，点击【Next \>】，修改【Platform Manufacturer】内容为“Vendor”，修改【Platform Name】内容为“Chip\_XX”，点击【Finish】完成平台数据库配置。
...
1.  上一步点击【Finish】后会出现一个会话窗口。在名称域内，找到DS-5调试器，右击—【New】，选择刚才创建的Vendor-Chip\_XX。
...
-   **[内存初始化](#ZH-CN_TOPIC_0000002457874809)**  

-   **[下载U-Boot映像](#ZH-CN_TOPIC_0000002424355898)**  

-   **[烧写映像](#ZH-CN_TOPIC_0000002457874797)**  
...
-   **[u-boot命令说明](#ZH-CN_TOPIC_0000002424355890)**  

## u-boot命令说明<a name="ZH-CN_TOPIC_0000002424355890"></a>

-   **[开启SPI-Nor块保护功能](#ZH-CN_TOPIC_0000002457874805)**  

-   **[SPI-Nor块保护命令](#ZH-CN_TOPIC_0000002424196066)**  

-   **[tftp命令的使用限制](#ZH-CN_TOPIC_0000002457834685)**  
